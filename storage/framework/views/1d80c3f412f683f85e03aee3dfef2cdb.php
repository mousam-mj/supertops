<?php $__env->startSection('title', ($config['product_name'] ?? 'Customize') . ' | Perch'); ?>
      ...
      <div class="nav-right">
        <div class="nav-cart-wrap">
          <div class="nav-cart-actions">
            <button type="button" class="add-cart-btn" id="top-cart-btn" onclick="addToCart()">Add to Cart – <?php echo e($config['currency']); ?><?php echo e(number_format($config['base_price'], 2)); ?></button>
        ...
        <a href="<?php echo e(route('home')); ?>" class="close-btn" title="Close">✕</a>
      </div>
    </div>
    <div class="content">
      <div class="left-col">
        <div class="bottle-title"><?php echo e($config['product_name'] ?? 'Customize'); ?></div>
        <div id="three-wrap">
      ...
      <div class="right-col">
        ...
        <div class="step-panel active" id="panel-1">
          ...
          <div class="step-counter">1 of <?php echo e($stepTotal); ?></div>
          ...
          <div class="size-cards" id="size-cards">
            ...
            ?>
            <?php if($sizeCount <= 1): ?>
              <?php $s0 = $sz[0] ?? ['name' => '', 'desc' => '', 'price' => null]; ?>
              <div class="size-static-text" id="size-static-only" data-size-idx="0" aria-live="polite">
                <?php if(!empty($s0['name'])): ?>
                  <p class="static-size-name"><?php echo e($s0['name']); ?></p>
                <?php endif; ?>
                <?php if(!empty($s0['desc'])): ?>
                  <p class="static-size-desc"><?php echo e($s0['desc']); ?></p>
                <?php endif; ?>
                <?php if(isset($s0['price']) && $s0['price'] !== '' && $s0['price'] !== null): ?>
                  <p class="static-size-price"><?php echo e($config['currency']); ?><?php echo e(number_format((float) $s0['price'], 2)); ?></p>
                <?php endif; ?>
              </div>
            <?php else: ?>
              <?php $__currentLoopData = $sz; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="size-card <?php echo e($i === $lastIdx ? 'selected' : ''); ?>" data-size-idx="<?php echo e($i); ?>" onclick="selectSize(<?php echo e($i); ?>)">
                ...
                <div class="option-info"><div class="option-name"><?php echo e($size['name'] ?? '40 oz'); ?></div><div class="option-desc"><?php echo e($size['desc'] ?? 'Large insulated tumbler with handle and straw.'); ?></div></div>
                <?php if(!empty($size['price'])): ?>
                <div class="option-price"><?php echo e($config['currency']); ?><?php echo e(number_format($size['price'], 2)); ?></div>
                <?php endif; ?>
              </div>
          ...
          <div class="color-name-label" id="bottle-color-label"><?php echo e(($config['bottle_colors'][0]['name'] ?? 'Lavender')); ?></div>
        ...
        <div class="step-panel" id="panel-2">
          ...
          <div class="step-counter">2 of <?php echo e($stepTotal); ?></div>
          ...
          <div class="color-name-label" id="cap-color-label"><?php echo e(($config['cap_colors'][0]['name'] ?? 'Lavender')); ?></div>
        ...
        <div class="step-panel" id="panel-3">
          ...
          <div class="step-counter">3 of <?php echo e($stepTotal); ?></div>
          ...
          <div class="color-name-label" id="strap-color-label"><?php echo e(($config['strap_colors'][0]['name'] ?? 'Lavender')); ?></div>
          <div class="bottom-nav">
        ...
        <div class="step-panel" id="panel-4">
          ...
          <div class="step-counter">4 of <?php echo e($stepTotal); ?></div>
          ...
          <div class="color-name-label" id="handle-color-label"><?php echo e(($config['handle_colors'][0]['name'] ?? 'Lavender')); ?></div>
          <div class="bottom-nav">
        ...
        <div class="step-panel" id="panel-5">
          ...
          <div class="step-counter">5 of <?php echo e($stepTotal); ?></div>
          ...
          <div class="color-name-label" id="boot-color-label"><?php echo e(($config['boot_colors'][0]['name'] ?? 'Lavender')); ?></div>
          <?php if($engrOn && !$engrCatMode): ?>
          <div class="customize-engraving-block" id="customize-engraving-wrap">
            <div class="engraving-label"><?php echo e($config['engraving_label'] ?? 'Engraving'); ?></div>
            <?php $engrP = (float) ($config['engraving_price'] ?? 0); ?>
            <p class="engraving-hint">Optional.<?php if($engrP > 0): ?> Add <?php echo e($config['currency'] ?? '₹'); ?><?php echo e(number_format($engrP, 2)); ?> when you enter text.<?php endif; ?> Max <?php echo e((int) ($config['engraving_max_chars'] ?? 40)); ?> characters.</p>
            ...
            <textarea id="customize-engraving-text" class="engraving-textarea" rows="2" maxlength="<?php echo e((int) ($config['engraving_max_chars'] ?? 40)); ?>" placeholder="e.g. your name" autocomplete="off"></textarea>
          </div>
          <?php endif; ?>
          <div class="bottom-nav">
            ...
            <button type="button" class="next-btn" onclick="addToCart()">Add to Cart – <span id="final-price"><?php echo e($config['currency']); ?><?php echo e(number_format($config['base_price'], 2)); ?></span></button>
            <button type="button" class="customize-checkout-btn" onclick="buyItNow()">Buy it now</button>
            <?php endif; ?>
          </div>
        </div>
        ...
        <div class="step-panel engraving-step" id="panel-6">
          <div class="step-heading"><?php echo e($config['engraving_label'] ?? 'Add Engraving'); ?></div>
          <div class="step-counter">6 of <?php echo e($stepTotal); ?></div>
          ...
          <div class="bottom-nav">
            ...
            <select class="qty-select" id="customize-qty" title="Quantity" onchange="onCustomizeQtyChange(this)"><option value="1" selected>1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select>
            <button type="button" class="next-btn" onclick="addToCart()">Add to Cart – <span id="final-price-engr"><?php echo e($config['currency']); ?><?php echo e(number_format($config['base_price'], 2)); ?></span></button>
            <button type="button" class="customize-checkout-btn" onclick="buyItNow()">Buy it now</button>
          </div>
        </div>
        <?php endif; ?>
...
?>
<script>window.CUSTOMIZE_CHECKOUT_URL = <?php echo json_encode(route('checkout.index'), 15, 512) ?>;</script>
<script>window.CUSTOMIZE_CONFIG = <?php echo json_encode($config, 15, 512) ?>;</script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js"></script>
<script src="<?php echo e(route('customize.app.js', ['v' => $customizeAppV])); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/customize.blade.php ENDPATH**/ ?>