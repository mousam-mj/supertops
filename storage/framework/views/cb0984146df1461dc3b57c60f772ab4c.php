<?php $__env->startSection('title', 'Product One Scrolling - Perch Bottle'); ?>
...
<div id="menu-mobile" class="">
                                                ...
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer active"> Products Grid 1 Scrolling </a>
                                                            </li>
                                                            <li>
                ...
                <div class="main bg-surface md:pt-[88px] pt-[70px] pb-[14px]">
                    <div class="container flex items-center justify-between flex-wrap gap-3">
                        <div class="left flex items-center gap-1">
                            ...
                            <i class="ph ph-caret-right text-xs text-secondary2"></i>
                            <div class="caption1 capitalize">Product One Scrolling</div>
                        </div>
        ...
        <div class="product-detail one-scrolling countdown-timer">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/product/one-scrolling.blade.php ENDPATH**/ ?>