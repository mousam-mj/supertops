<?php $__env->startSection('title', 'Product Thumbnail Left - Perch Bottle'); ?>
...
<div id="menu-mobile" class="">
                                                ...
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('my-account')); ?>" class="link text-secondary duration-300"> My Account </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="list-nav-item w-full pt-2 pb-6">
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer active"> Products Thumbnails Left </a>
                                                            </li>
                                                            <li>
                ...
                <div class="main bg-surface md:pt-[88px] pt-[70px] pb-[14px]">
                    <div class="container flex items-center justify-between flex-wrap gap-3">
                        <div class="left flex items-center gap-1">
                            <a href="<?php echo e(route('home')); ?>" class="caption1 text-secondary2 hover:underline">Homepage</a>
                            <i class="ph ph-caret-right text-xs text-secondary2"></i>
                            <div class="caption1 text-secondary2">Product</div>
                            <i class="ph ph-caret-right text-xs text-secondary2"></i>
                            <div class="caption1 capitalize">Product Thumbnail Left</div>
                        </div>
        ...
        <div class="product-detail thumbnail-left default">
                    ...
                    <div class="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
                        ...
                        <div class="list-action mt-6">
                            ...
                            <div class="button-block mt-5">
                                <a href="<?php echo e(route('checkout.index')); ?>" class="button-main w-full text-center">Buy It Now</a>
                            </div>
                            ...
                            <div class="list-collection">
                                <div class="swiper swiper-product-scroll h-full relative">
                                    <div class="swiper-wrapper">
                                                ...
                                                <div class="product-main cursor-pointer block">
                                                    <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                                        ...
                                                        <div class="product-img w-full h-full aspect-[3/4]">
                                                            <img class="w-full h-full object-cover duration-700" src="<?php echo e(asset('assets/images/product/1000x1000.png" alt="img') " />
                                                    ...
                                                    <div class="product-infor mt-4 lg:mb-7">
                                                        ...
                                                        <div class="product-name text-title duration-300">Off-the Shoulder</div>
                                            ...
                                            <div class="product-item grid-type" data-item="4">
                                                <div class="product-main cursor-pointer block">
                                                    ...
                                                    <div class="product-infor mt-4 lg:mb-7">
                                                        ...
                                                        <div class="product-name text-title duration-300">T-shirt Pocket</div>
                                                        <div class="list-color py-2 max-md:hidden flex items-center gap-3 flex-wrap duration-500">
                                                            <div class="color-item bg-red w-8 h-8 rounded-full duration-300 relative">
                                                                <div class="tag-action bg-black text-white caption2 capitalize px-1.5 py-0.5 rounded-sm">Red</div>
                                                            </div>
                                            ...
                                            <div class="product-item grid-type" data-item="5">
                                                <div class="product-main cursor-pointer block">
                                                    ...
                                                    <div class="product-infor mt-4 lg:mb-7">
                                                        ...
                                                        <div class="product-name text-title duration-300">Body Dress</div>
                                                        <div class="list-color py-2 max-md:hidden flex items-center gap-3 flex-wrap duration-500">
                                                            <div class="color-item bg-red w-8 h-8 rounded-full duration-300 relative">
                                                                <div class="tag-action bg-black text-white caption2 capitalize px-1.5 py-0.5 rounded-sm">Red</div>
                                                            </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product-item grid-type" data-item="6">
                                                <div class="product-main cursor-pointer block">
                                                    <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                                        <div class="product-tag text-button-uppercase bg-green px-3 py-0.5 inline-block rounded-full absolute top-3 left-3 z-[1]">New</div>
                                                        <div class="list-action-right absolute top-3 right-3 max-lg:hidden">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product-item grid-type" data-item="7">
                                                <div class="product-main cursor-pointer block">
                                                    <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                                        <div class="product-tag text-button-uppercase bg-green px-3 py-0.5 inline-block rounded-full absolute top-3 left-3 z-[1]">New</div>
                                                        <div class="list-action-right absolute top-3 right-3 max-lg:hidden">
                                                    ...
                                                    <div class="product-infor mt-4 lg:mb-7">
                                                        ...
                                                        <div class="product-name text-title duration-300">Office Shirt</div>
                                                        <div class="list-color py-2 max-md:hidden flex items-center gap-3 flex-wrap duration-500">
                                                            <div class="color-item bg-red w-8 h-8 rounded-full duration-300 relative">
                                                                <div class="tag-action bg-black text-white caption2 capitalize px-1.5 py-0.5 rounded-sm">Red</div>
                                                            </div>
                        ...
                        <div class="desc-item specifications flex items-center justify-center" data-item="Specifications">
                            <div class="lg:w-1/2 sm:w-3/4 w-full">
                                ...
                                <div class="item bg-surface flex items-center gap-8 py-3 px-10">
                                    ...
                                    <p><?php echo e(isset($availableColors) && count($availableColors) > 0 ? implode(', ', $availableColors) : '—'); ?></p>
                                </div>
                                <div class="item flex items-center gap-8 py-3 px-10">
            ...
            <div class="review-block md:py-20 py-10 bg-surface">
                <div class="container">
                    <div class="heading flex items-center justify-between flex-wrap gap-4">
                        <div class="heading4">Customer Review</div>
                        <a href="#form-review" class="button-main bg-white text-black border border-black">Write Reviews </a>
                    </div>
                    <div class="top-overview flex justify-between py-6 max-md:flex-col gap-y-6">
                        ...
                        <div class="list-img lg:w-3/4 md:w-[70%] lg:pl-[15px] md:pl-[15px]">
                            <div class="heading5">All Image (128)</div>
                            <div class="list md:mt-6 mt-3">
                                <div class="swiper swiper-img-review h-full relative">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="{{ asset('assets/images/product/1000x1000.png" alt="img" class="w-[120px] aspect-square object-cover rounded-lg') " />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{ asset('assets/images/product/1000x1000.png" alt="img" class="w-[120px] aspect-square object-cover rounded-lg') " />
                                        </div>
                            ...
                            <div class="sorting flex items-center flex-wrap md:gap-5 gap-3 gap-y-3 mt-6">
                                <div class="text-button">Sort by</div>
                                <div class="item bg-white px-4 py-1 border border-line rounded-full">Newest</div>
                                <div class="item bg-white px-4 py-1 border border-line rounded-full">5 Star</div>
                                <div class="item bg-white px-4 py-1 border border-line rounded-full">4 Star</div>
                                <div class="item bg-white px-4 py-1 border border-line rounded-full">3 Star</div>
                                <div class="item bg-white px-4 py-1 border border-line rounded-full">2 Star</div>
                                <div class="item bg-white px-4 py-1 border border-line rounded-full">1 Star</div>
                            </div>
                        </div>
                    </div>
                    <div class="list-review">
                        <div class="item flex max-lg:flex-col gap-y-4 w-full py-6 border-t border-line">
                            <div class="left lg:w-1/4 w-full lg:pr-[15px]">
                                <div class="list-img-review flex gap-2">
                                    <img src="{{ asset('assets/images/product/1000x1000.png" alt="img" class="w-[60px] aspect-square rounded-lg') " />
                                    <img src="{{ asset('assets/images/product/1000x1000.png" alt="img" class="w-[60px] aspect-square rounded-lg') " />
                                    <img src="{{ asset('assets/images/product/1000x1000.png" alt="img" class="w-[60px] aspect-square rounded-lg') " />
                                </div>
                                <div class="user mt-3">
                            ...
                            <div class="right lg:w-3/4 w-full lg:pl-[15px]">
                                ...
                                <div class="heading5 mt-3">Unbeatable Style and Quality: A Fashion Brand That Delivers</div>
                                <div class="body1 mt-3">I can't get enough of the fashion pieces from this brand. They have a great selection for every occasion and the prices are reasonable. The shipping is fast and the items always arrive in perfect condition.</div>
                        ...
                        <div class="item flex max-lg:flex-col gap-y-4 w-full py-6 border-t border-line">
                            ...
                            <div class="right lg:w-3/4 w-full lg:pl-[15px]">
                                ...
                                <div class="heading5 mt-3">Exceptional Fashion: The Perfect Blend of Style and Durability</div>
                                <div class="body1 mt-3">The fashion brand's online shopping experience is seamless. The website is user-friendly, the product images are clear, and the checkout process is quick.</div>
                                <div class="action mt-3">
                                    <div class="flex items-center gap-4">
                                        <div class="like-btn flex items-center gap-1 cursor-pointer">
                                            <i class="ph ph-hands-clapping text-lg"></i>
                        ...
                        <div class="item flex max-lg:flex-col gap-y-4 w-full py-6 border-t border-line">
                            ...
                            <div class="right lg:w-3/4 w-full lg:pl-[15px]">
                                ...
                                <div class="heading5 mt-3">Elevate Your Wardrobe: Stunning Dresses That Make a Statement</div>
                                <div class="body1 mt-3">I love how sustainable and ethically conscious this fashion brand is. They prioritize eco-friendly materials and fair trade practices, which makes me feel good about supporting them.</div>
                                <div class="action mt-3">
                                    <div class="flex items-center gap-4">
                                        <div class="like-btn flex items-center gap-1 cursor-pointer">
                                            <i class="ph ph-hands-clapping text-lg"></i>
                        ...
                        <div class="text-button more-review-btn text-center mt-2 underline cursor-pointer">View More Comments</div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/product/thumbnail-left.blade.php ENDPATH**/ ?>