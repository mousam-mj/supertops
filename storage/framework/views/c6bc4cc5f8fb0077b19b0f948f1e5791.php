<?php $__env->startSection('title', 'Shop Default - Perch Bottle'); ?>
                                            ...
                                            <div class="list-nav-item w-full pt-2 pb-6">
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer active"> Shop Default </a>
                                                            </li>
                                                            <li>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/shop/default.blade.php ENDPATH**/ ?>