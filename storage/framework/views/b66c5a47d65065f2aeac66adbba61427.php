...
<head>
    ...
    <title>Verify Your Email - <?php echo e(config('app.name')); ?></title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background-color: #fff; padding: 30px; margin-top: 20px;">
        ...
        <p>Thank you for registering with <?php echo e(config('app.name')); ?>! Please verify your email address by clicking the button below.</p>
        ...
        <p style="color: #666; font-size: 12px; word-break: break-all;"><?php echo e($verificationUrl); ?></p>
        ...
        <p>Thank you,<br><?php echo e(config('app.name')); ?> Team</p>
    </div>
...
<?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/emails/verify-email.blade.php ENDPATH**/ ?>