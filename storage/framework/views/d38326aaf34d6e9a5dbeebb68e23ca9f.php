<?php $__env->startSection('title', 'My Account - Perch Bottle'); ?>
                    ...
                    <div class="container h-full">
                        <div class="menu-main h-full overflow-hidden">
                            <div class="heading py-2 relative flex items-center justify-center">
                                ...
                                <a href="<?php echo e(route('home')); ?>" class="logo text-3xl font-semibold text-center">Anvogue</a>
                            </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="sub-nav-mobile">
                                            ...
                                            <div class="list-nav-item w-full grid grid-cols-2 pt-2 pb-6">
                                                <ul>
                                                    <li>
                                                        <a href="<?php echo e(route('home')); ?>" class="nav-item-mobile link text-secondary duration-300"> Home Fashion 1 </a>
                                                    </li>
                                                    <li>
                                            ...
                                            <div class="list-nav-item w-full pt-2 pb-6">
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6">
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Starting From 50% Off </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Outerwear | Coats </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Sweaters | Cardigans </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Shirt | Sweatshirts </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 view-all-btn"> View All </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Faces Skin </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Eyes Makeup </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Lip Polish </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Hair Care </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 view-all-btn"> View All </a>
                                                            </li>
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Cented Candle </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Health Drinks </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Yoga Clothes </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Yoga Equipment </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 view-all-btn"> View All </a>
                                                            </li>
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Starting From 60% Off </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Dresses | Jumpsuits </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> T-shirts | Sweatshirts </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Accessories | Jewelry </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 view-all-btn"> View All </a>
                                                            </li>
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Kids Bed </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Boy's Toy </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Baby Blanket </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Newborn Clothing </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 view-all-btn"> View All </a>
                                                            </li>
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Furniture | Decor </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Table | Living Room </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Chair | Work Room </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Lighting | Bed Room </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 view-all-btn"> View All </a>
                                                            </li>
                                            ...
                                            <div class="list-nav-item w-full pt-2 pb-6">
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300"> Shop Breadcrumb IMG </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300"> Shop Breadcrumb 1 </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300"> Shop Breadcrumb 2 </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300"> Shop Collection </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300"> Shop Filter Canvas </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300"> Shop Filter Options </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300"> Shop Filter Dropdown </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300"> Shop Sidebar List </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Shop Default </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Shop Default Grid </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Shop Default List </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer"> Shop Full Width </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300"> Shop Square </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('wishlist')); ?>" class="link text-secondary duration-300"> Wish List </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('search')); ?>" class="link text-secondary duration-300"> Search Result </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('cart.index')); ?>" class="link text-secondary duration-300"> Shopping Cart </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('login')); ?>" class="link text-secondary duration-300"> Login/Register </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('forgot-password')); ?>" class="link text-secondary duration-300"> Forgot Password </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('order-tracking')); ?>" class="link text-secondary duration-300"> Order Tracking </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('my-account')); ?>" class="link text-secondary duration-300 active"> My Account </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="list-nav-item w-full pt-2 pb-6">
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300"> Products Defaults </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300"> Products Sale </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300"> Products Countdown Timer </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300"> Products Grouped </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300"> Frequently Bought Together </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300"> Products Out Of Stock </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300"> Products Variable </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300"> Products External </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300"> Products On Sale </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300"> Products With Discount </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300"> Products With Sidebar </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300"> Products Fixed Price </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer"> Products Thumbnails Left </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer"> Products Thumbnails Bottom </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer"> Products Grid 1 Scrolling </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer"> Products Grid 2 Scrolling </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer"> Products Combined 1 </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer"> Products Combined 2 </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer"> Products Style 01 </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer"> Products Style 02 </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer"> Products Style 03 </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer"> Products Style 04 </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer"> Products Style 05 </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="sub-nav-mobile">
                                            ...
                                            <div class="list-nav-item w-full pt-2 pb-6">
                                                <ul class="w-full">
                                                    <li>
                                                        <a href="<?php echo e(route('home')); ?>" class="link text-secondary duration-300"> Blog Default </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(route('home')); ?>" class="link text-secondary duration-300"> Blog List </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(route('home')); ?>" class="link text-secondary duration-300"> Blog Grid </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(route('home')); ?>" class="link text-secondary duration-300"> Blog Detail 1 </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(route('home')); ?>" class="link text-secondary duration-300"> Blog Detail 2 </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="sub-nav-mobile">
                                            ...
                                            <div class="list-nav-item w-full pt-2 pb-6">
                                                <ul class="w-full">
                                                    <li>
                                                        <a href="<?php echo e(route('about')); ?>" class="link text-secondary duration-300"> About Us </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(route('contact')); ?>" class="link text-secondary duration-300"> Contact Us </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(route('home')); ?>" class="link text-secondary duration-300"> Store List </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(route('home')); ?>" class="link text-secondary duration-300"> 404 </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(route('faqs')); ?>" class="link text-secondary duration-300"> FAQs </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(route('home')); ?>" class="link text-secondary duration-300"> Coming Soon </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(route('home')); ?>" class="link text-secondary duration-300"> Customer Feedbacks </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                ...
                <div class="content-main lg:px-[60px] md:px-4 flex gap-y-8 max-md:flex-col w-full">
                        ...
                        <div class="user-infor bg-surface md:px-8 px-5 md:py-10 py-6 md:rounded-[20px] rounded-xl">
                            <div class="heading flex flex-col items-center justify-center">
                                <div class="avatar">
                                    ...
                                    ?>
                                    <img src="<?php echo e($avatarUrl); ?>" alt="avatar" class="md:w-[140px] w-[120px] md:h-[140px] h-[120px] rounded-full object-cover" onerror="this.onerror=null; this.src='<?php echo e($avatarFallback); ?>';" />
                                </div>
                                <div class="name heading6 mt-4 text-center"><?php echo e($user->name ?? ($user->first_name . ' ' . $user->last_name) ?? 'User'); ?></div>
                                <div class="mail heading6 font-normal normal-case text-secondary text-center mt-1"><?php echo e($user->email); ?></div>
                            </div>
                    ...
                    <div class="right list-filter md:w-2/3 w-full pl-2.5">
                        <div class="filter-item text-content w-full active" data-item="dashboard">
                            <?php if(session('welcome_message') || request()->get('welcome_message')): ?>
                                <div class="mb-6 p-4 rounded-xl bg-green-50 border border-green-200 flex items-center gap-3">
                                    ...
                                    <p class="text-green-800 font-medium"><?php echo e(session('welcome_message') ?? request()->get('welcome_message')); ?></p>
                                </div>
                            <?php endif; ?>
                            <?php if(session('login_success') || request()->get('login_success')): ?>
                                <div class="mb-6 p-4 rounded-xl bg-blue-50 border border-blue-200 flex items-center gap-3">
                                    ...
                                    <p class="text-blue-800 font-medium"><?php echo e(session('login_success') ?? request()->get('login_success')); ?></p>
                                </div>
                            <?php endif; ?>
                            <div class="overview grid sm:grid-cols-3 gap-5">
                                <div class="overview-item flex items-center justify-between p-5 border border-line rounded-lg box-shadow-xs">
                                    <div class="counter">
                                        ...
                                        <h5 class="heading5 mt-1"><?php echo e($awaitingPickup ?? 0); ?></h5>
                                    </div>
                                ...
                                <div class="overview-item flex items-center justify-between p-5 border border-line rounded-lg box-shadow-xs">
                                    <div class="counter">
                                        ...
                                        <h5 class="heading5 mt-1"><?php echo e($cancelledOrders ?? 0); ?></h5>
                                    </div>
                                ...
                                <div class="overview-item flex items-center justify-between p-5 border border-line rounded-lg box-shadow-xs">
                                    <div class="counter">
                                        ...
                                        <h5 class="heading5 mt-1"><?php echo e($totalOrders ?? 0); ?></h5>
                                    </div>
                                        ...
                                        <table class="w-full max-[1400px]:w-[700px] max-md:w-[700px]">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    ?>
                                                    <tr class="item duration-300 <?php echo e(!$loop->last ? 'border-b border-line' : ''); ?>">
                                                        <th scope="row" class="py-3 text-left">
                                                            <strong class="text-title"><?php echo e($order->order_number); ?></strong>
                                                        </th>
                                                        <td class="py-3">
                                                            <a href="<?php echo e(route('product.show', $productSlug)); ?>" class="product flex items-center gap-3">
                                                                <img src="<?php echo e($productImage); ?>" alt="<?php echo e($productName); ?>" class="flex-shrink-0 w-12 h-12 rounded" />
                                                                <div class="info flex flex-col">
                                                                    <strong class="product_name text-button"><?php echo e($productName); ?></strong>
                                                                    <?php if($categoryName): ?>
                                                                        <span class="product_tag caption1 text-secondary"><?php echo e($categoryName); ?></span>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </a>
                                                        </td>
                                                        <td class="py-3 price">₹<?php echo e(number_format($totalAmount, 2)); ?></td>
                                        ...
                                        <div class="order_item mt-5 border border-line rounded-lg box-shadow-xs">
                                            <div class="flex flex-wrap items-center justify-between gap-4 p-5 border-b border-line">
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <strong class="order_number text-button uppercase"><?php echo e($order->order_number); ?></strong>
                                                </div>
                                                <div class="flex items-center gap-2">
                                            ...
                                            <div class="list_prd px-5">
                                                <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    ?>
                                                    <div class="prd_item flex flex-wrap items-center justify-between gap-3 py-5 <?php echo e(!$loop->last ? 'border-b border-line' : ''); ?>">
                                                        <a href="<?php echo e(route('product.show', $productSlug)); ?>" class="flex items-center gap-5">
                                                            ...
                                                            <div>
                                                                <div class="prd_name text-title"><?php echo e($productName); ?></div>
                                                                <?php if($item->size || $item->color): ?>
                                                                    <div class="caption1 text-secondary mt-2">
                                                                        <?php if($item->size): ?>
                                                                            <span class="prd_size uppercase"><?php echo e($item->size); ?></span>
                                                                        <?php endif; ?>
                                                                        <?php if($item->size && $item->color): ?>
                                                                            <span>/</span>
                                                                        <?php endif; ?>
                                                                        <?php if($item->color): ?>
                                                                            <span class="prd_color capitalize"><?php echo e($item->color); ?></span>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                <?php endif; ?>
                                                            </div>
                                                        ...
                                                        <div class="text-title">
                                                            <span class="prd_quantity"><?php echo e($item->quantity); ?></span>
                                                            <span> X </span>
                                                            <span class="prd_price">₹<?php echo e(number_format($itemPrice, 2)); ?></span>
                                                        </div>
                                                    </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                            <div class="flex flex-wrap gap-4 p-5">
                                                <a href="<?php echo e(route('account.orders.show', $order->id)); ?>" class="button-main btn_order_detail">Order Details</a>
                                                <?php if($order->status !== 'cancelled' && $order->status !== 'canceled' && $order->status !== 'completed' && $order->status !== 'delivered'): ?>
                                                    <button class="button-main bg-surface border border-line hover:bg-black text-black hover:text-white" onclick="cancelOrder(<?php echo e($order->id); ?>)">Cancel Order</button>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="filter-item tab_address text-content w-full p-7 border border-line rounded-xl" data-item="address">
                            ...
                            <?php if($addresses && $addresses->count() > 0): ?>
                                <div class="address-list space-y-4">
                                    <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="address-item border border-line rounded-lg p-5 <?php echo e($address->is_default ? 'bg-surface' : ''); ?>" data-address-id="<?php echo e($address->id); ?>" data-address='<?php echo json_encode($address, 15, 512) ?>'>
                                            <div class="flex items-start justify-between gap-4">
                                                <div class="flex-1">
                                                    <div class="flex items-center gap-2 mb-2">
                                                        <strong class="text-title"><?php echo e($address->label ?? 'Address'); ?></strong>
                                                    ...
                                                    <div class="text-secondary caption1">
                                                        <p class="font-semibold text-title"><?php echo e($address->full_name); ?></p>
                                                        <p><?php echo e($address->address_line_1); ?></p>
                                                        <?php if($address->address_line_2): ?>
                                                            <p><?php echo e($address->address_line_2); ?></p>
                                                        <?php endif; ?>
                                                        <p><?php echo e($address->city); ?>, <?php echo e($address->state); ?> - <?php echo e($address->pincode); ?></p>
                                                        <p class="mt-2">Phone: <?php echo e($address->phone); ?></p>
                                                    </div>
                                                </div>
                                                <div class="flex items-center gap-2">
                                                    <button type="button" class="button-main bg-surface border border-line hover:bg-black text-black hover:text-white text-sm px-4 py-2" onclick="editAddress(<?php echo e($address->id); ?>)">Edit</button>
                                                    <?php if(!$address->is_default): ?>
                                                        <form method="POST" action="/addresses/<?php echo e($address->id); ?>/set-default" class="inline">
                                                            <?php echo csrf_field(); ?>
                                                        ...
                                                        <form method="POST" action="/addresses/<?php echo e($address->id); ?>" class="inline" onsubmit="return confirm('Are you sure you want to delete this address?');">
                                                            <?php echo csrf_field(); ?>
                            ...
                            <div id="addressForm" class="<?php echo e(($errors->any() && request('tab') === 'address') ? '' : 'hidden'); ?> mt-6 border-t border-line pt-6">
                                <h6 class="heading6 mb-4" id="formTitle"><?php echo e($addressFormEdit ? 'Edit Address' : 'Add New Address'); ?></h6>
                                <form id="addressFormElement" method="POST" action="/my-account">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="address_id" id="addressId" value="<?php echo e($addressFormEdit ? request('edit') : ''); ?>">
                                    <?php if($errors->has('error')): ?>
                                        <div class="mb-4 p-3 rounded-lg bg-red-50 border border-red-200 text-red-700 caption1"><?php echo e($errors->first('error')); ?></div>
                                    <?php endif; ?>
                                    <div class="grid sm:grid-cols-2 gap-4 gap-y-5">
                                        <div class="label">
                                            ...
                                            <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="addressLabel" name="label" type="text" value="<?php echo e(old('label', 'Home')); ?>" placeholder="Home, Office, etc." required />
                                            <?php $__errorArgs = ['label'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red text-sm mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="full-name">
                                            ...
                                            <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="addressFullName" name="full_name" type="text" value="<?php echo e(old('full_name', $user->name ?? '')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="phone">
                                            ...
                                            <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="addressPhone" name="phone" type="text" value="<?php echo e(old('phone', $user->phone ?? '')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="address-line-1">
                                            ...
                                            <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="addressLine1" name="address_line_1" type="text" value="<?php echo e(old('address_line_1')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="address-line-2">
                                            ...
                                            <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="addressLine2" name="address_line_2" type="text" value="<?php echo e(old('address_line_2')); ?>" />
                                        </div>
                                        <div class="city">
                                            <label for="addressCity" class="caption1 capitalize">City <span class="text-red">*</span></label>
                                            <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="addressCity" name="city" type="text" value="<?php echo e(old('city')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="state">
                                            ...
                                            <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="addressState" name="state" type="text" value="<?php echo e(old('state')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="pincode">
                                            ...
                                            <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="addressPincode" name="pincode" type="text" maxlength="6" value="<?php echo e(old('pincode')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="is-default col-span-full">
                                            <label class="flex items-center gap-2 cursor-pointer">
                                                <input type="checkbox" name="is_default" id="addressIsDefault" value="1" class="w-4 h-4" <?php echo e(old('is_default') ? 'checked' : ''); ?>>
                                                <span class="caption1">Set as default address</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="flex gap-4 mt-6">
                                        <button type="submit" class="button-main bg-black" id="saveAddressBtn"><?php echo e($addressFormEdit ? 'Update Address' : 'Save Address'); ?></button>
                        ...
                        <div class="filter-item text-content w-full p-7 border border-line rounded-xl" data-item="setting">
                            <?php if(session('settings_success')): ?>
                                <div class="mb-4 p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg">
                            ...
                            <?php if($errors->any() && request('tab') === 'setting'): ?>
                                <div class="mb-4 p-4 bg-red-100 border border-red-400 text-red-700 rounded-lg">
                                    <ul class="list-disc list-inside">
                                        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><?php echo e($error); ?></li>
                            ...
                            <form method="POST" action="<?php echo e(route('my-account.settings.update')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="upload_image col-span-full">
                                    ...
                                    <div class="flex flex-wrap items-center gap-5 mt-3">
                                        <div class="bg_img flex-shrink-0 relative w-[7.5rem] h-[7.5rem] rounded-lg overflow-hidden bg-surface">
                                            ...
                                            <img src="<?php echo e($avatarUrl); ?>" alt="avatar" class="upload_img relative z-[1] w-full h-full object-cover" id="avatarPreview" onerror="this.onerror=null; this.src='<?php echo e($avatarFallback); ?>';" />
                                        </div>
                                        <div>
                                ...
                                <div class="grid sm:grid-cols-2 gap-4 gap-y-5 mt-5">
                                    <div class="first-name">
                                        ...
                                        <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="firstName" name="first_name" type="text" value="<?php echo e(old('first_name', $user->first_name ?? explode(' ', $user->name ?? '')[0] ?? '')); ?>" placeholder="First name" required />
                                    </div>
                                    <div class="last-name">
                                        <label for="lastName" class="caption1 capitalize">Last Name <span class="text-red">*</span></label>
                                        <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="lastName" name="last_name" type="text" value="<?php echo e(old('last_name', $user->last_name ?? (count(explode(' ', $user->name ?? '')) > 1 ? explode(' ', $user->name)[1] : ''))); ?>" placeholder="Last name" required />
                                    </div>
                                    <div class="phone-number">
                                        <label for="phoneNumber" class="caption1 capitalize">Phone Number <span class="text-red">*</span></label>
                                        <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="phoneNumber" name="phone" type="text" value="<?php echo e(old('phone', $user->phone ?? '')); ?>" placeholder="Phone number" required />
                                    </div>
                                    <div class="email">
                                        <label for="email" class="caption1 capitalize">Email Address <span class="text-red">*</span></label>
                                        <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="email" name="email" type="email" value="<?php echo e(old('email', $user->email)); ?>" placeholder="Email address" required />
                                    </div>
                                    <div class="gender">
                                    ...
                                    <div class="birth">
                                        ...
                                        <input class="border-line mt-2 px-4 py-3 w-full rounded-lg" id="birth" name="date_of_birth" type="date" value="<?php echo e(old('date_of_birth', $user->date_of_birth ?? '')); ?>" placeholder="Day of Birth" />
                                    </div>
                                </div>
                        ...
                        <div class="filter-item text-content w-full p-7 border border-line rounded-xl" data-item="change-password">
                            ...
                            <?php if($errors->any() && request('tab') === 'change-password'): ?>
                                <div class="mb-4 p-4 bg-red-100 border border-red-400 text-red-700 rounded-lg">
                                    <ul class="list-disc list-inside">
                                        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><?php echo e($error); ?></li>
                            ...
                            <form method="POST" action="<?php echo e(route('my-account.password.update')); ?>">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                ...
                                <div class="pass">
                                    ...
                                    <div class="relative mt-2">
                                        <input class="border-line px-4 py-3 w-full rounded-lg pr-12" id="current_password" name="current_password" type="password" placeholder="Current Password *" value="<?php echo e(old('current_password')); ?>" required />
                                ...
                                <div class="new-pass mt-5">
                                    ...
                                    <div class="relative mt-2">
                                        <input class="border-line px-4 py-3 w-full rounded-lg pr-12" id="new_password" name="new_password" type="password" placeholder="New Password *" value="<?php echo e(old('new_password')); ?>" required />
                                ...
                                <div class="confirm-pass mt-5">
                                    ...
                                    <div class="relative mt-2">
                                        <input class="border-line px-4 py-3 w-full rounded-lg pr-12" id="confirm_password" name="new_password_confirmation" type="password" placeholder="Confirm Password *" value="<?php echo e(old('new_password_confirmation')); ?>" required />
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/my-account.blade.php ENDPATH**/ ?>