<?php $__env->startSection('title', 'Index - Perch Bottle'); ?>
                                        ...
                                        <div class=" w-full h-full relative">
                                            ...
                                            <div class="sub-img absolute inset-0 w-full h-full">
                                                <?php if($banner->banner_image): ?>
                                                    <img src="<?php echo e(storage_asset($banner->banner_image)); ?>" alt="<?php echo e($banner->name); ?>" class="w-full h-full object-cover" />
                                                <?php else: ?>
                                                    <img src="<?php echo e(asset('assets/images/slider/03b-scaled.webp')); ?>" alt="<?php echo e($banner->name); ?>" class="w-full h-full object-cover" />
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="slider-item h-full w-full relative overflow-hidden">
                                        <div class="container w-full h-full">
                                            <div class="sub-img absolute inset-0 w-full h-full">
                                                <img src="<?php echo e(asset('assets/images/slider/03b-scaled.webp')); ?>" alt="Hero" class="w-full h-full object-cover" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<div class="collection-block mt-5">
            ...
            <div class="container">
                <div class="list-banner grid md:grid-cols-3 gap-[20px]">
                    ...
                    ?>
                    <?php $__empty_1 = true; $__currentLoopData = $homeCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="banner-item relative bg-surface block rounded-[20px] overflow-hidden duration-500">
                            <div class="banner-img w-full">
                                <?php if($category->image): ?>
                                    <img src="<?php echo e(storage_asset($category->image)); ?>" alt="<?php echo e($category->name); ?>" class="w-full duration-500" />
                                <?php else: ?>
                                    <img src="<?php echo e($defaultImages[$index] ?? $defaultImages[0]); ?>" alt="<?php echo e($category->name); ?>" class="w-full duration-500" />
                                <?php endif; ?>
                            </div>
                            <div class="heading4 absolute top-8 left-1/2 -translate-x-1/2 whitespace-nowrap"><?php echo e($category->name); ?></div>
                            <a href="<?php echo e(route('shop')); ?>" class="button-main absolute bottom-8 left-1/2 -translate-x-1/2">Shop Now</a>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        
                        <div class="banner-item relative bg-surface block rounded-[20px] overflow-hidden duration-500">
                            <div class="banner-img w-full">
                                <img src="<?php echo e(asset('assets/images/product/Bottle-1.webp')); ?>" alt="bg-img" class="w-full duration-500" />
                            </div>
                        ...
                        <div class="banner-item relative bg-surface block rounded-[20px] overflow-hidden duration-500">
                            <div class="banner-img w-full">
                                <img src="<?php echo e(asset('assets/images/product/Bottle-4.webp')); ?>" alt="bg-img" class="w-full duration-500" />
                            </div>
                        ...
                        <div class="banner-item relative bg-surface block rounded-[20px] overflow-hidden duration-500">
                            <div class="banner-img w-full">
                                <img src="<?php echo e(asset('assets/images/product/Bottle-8.webp')); ?>" alt="bg-img" class="w-full duration-500" />
                            </div>
            ...
            <div class="container">
                <div class="main-content relative flex max-lg:flex-wrap gap-y-5 items-center lg:justify-end justify-center">
                    <div class="heading bg-white xl:py-20 py-10 xl:px-10 px-8 rounded-2xl lg:w-[30%] lg:absolute lg:top-1/2 lg:-translate-y-1/2 lg:left-0 z-[1] max-lg:text-center">
                        ...
                        <a href="<?php echo e(route('shop.collection')); ?>" class="button-main bg-green lg:w-full text-center lg:mt-8 mt-5 text-black hover:bg-black hover:text-white">Shop Collection </a>
                    </div>
                    <div class="list popular-product w-3/4 grid sm:grid-cols-2 gap-4 max-lg:w-full">
                        <div class="item relative rounded-xl overflow-hidden">
                            <img src="<?php echo e(asset('assets/images/banner/perch123(1).webp')); ?>" alt="/images/banner/perch123(1).webp" class="w-full h-full object-cover" />
                            <!--<div class="dots absolute top-[22%] left-[55%] cursor-pointer">
                                ...
                                <a href="<?php echo e(route('shop')); ?>" class="product-infor bg-white rounded-2xl p-4 cursor-pointer">
                        ...
                        <div class="item relative rounded-xl overflow-hidden">
                            <img src="<?php echo e(asset('assets/images/banner/perch123(2).webp')); ?>" alt="/images/banner/perch123(2).webp" class="w-full h-full object-cover" />
        ...
        <div class="banner-block style-one grid sm:grid-cols-1 ">
            <a href="<?php echo e(route('shop')); ?>" class="banner-item relative block overflow-hidden duration-500">
                <div class="banner-img">
                    <img src="<?php echo e(asset('assets/images/banner/Blog-3.webp')); ?>"  alt="img" />
                </div>
        ...
        <div class="tab-features-block filter-prodduct-block md:pt-20 pt-10" id="home-best-sellers-section">
            <div class="container">
                ...
                <div class="list-product home-tab-products hide-product-sold grid xl:grid-cols-4 sm:grid-cols-3 grid-cols-2 md:gap-[30px] gap-4 relative section-swiper-navigation style-outline style-small-border md:mt-10 mt-6" data-tab="best sellers">
                    <?php $__empty_1 = true; $__currentLoopData = $bestSellers->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php echo $__env->make('partials.product-card', ['product' => $product], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-span-full text-center py-10">
                            <p class="text-secondary">No products available</p>
                ...
                <div class="list-product home-tab-products hide-product-sold grid xl:grid-cols-4 sm:grid-cols-3 grid-cols-2 md:gap-[30px] gap-4 relative section-swiper-navigation style-outline style-small-border md:mt-10 mt-6 hidden" data-tab="on sale">
                    <?php $__empty_1 = true; $__currentLoopData = $onSaleProducts->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php echo $__env->make('partials.product-card', ['product' => $product], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-span-full text-center py-10">
                ...
                <div class="list-product home-tab-products hide-product-sold grid xl:grid-cols-4 sm:grid-cols-3 grid-cols-2 md:gap-[30px] gap-4 relative section-swiper-navigation style-outline style-small-border md:mt-10 mt-6 hidden" data-tab="new arrivals">
                    <?php $__empty_1 = true; $__currentLoopData = $newArrivals->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php echo $__env->make('partials.product-card', ['product' => $product], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-span-full text-center py-10">
                            ...
                            <div class="list overflow-x-auto sm:pr-6">
                                <div class="product-item item pb-5 flex items-center justify-between gap-3 border-b border-line" data-item="1">
                                    <div class="infor flex items-center gap-5">
                                        <div class="bg-img">
                                            <img src="<?php echo e(asset('assets/images/product/perch-bottal.webp')); ?>" alt="img" class="w-[100px] aspect-square flex-shrink-0 rounded-lg" />
                            </div>
                                        <div class="">
        ...
        <div class="modal-wishlist-block">
            <div class="modal-wishlist-main py-6">
                ...
                <div class="footer-modal p-6 border-t bg-white border-line absolute bottom-0 left-0 w-full text-center">
                    <a href="<?php echo e(route('shop')); ?>" class="button-main w-full text-center uppercase"> View All Wish List</a>
                    ...
                    <div class="footer-modal bg-white absolute bottom-0 left-0 w-full">
                        ...
                        <div class="block-button text-center p-6">
                            <div class="flex items-center gap-4">
                                <a href="<?php echo e(route('shop')); ?>" class="button-main basis-1/2 bg-white border border-black text-black text-center uppercase"> View cart </a>
                                <a href="<?php echo e(route('shop')); ?>" class="button-main basis-1/2 text-center uppercase"> Check Out </a>
                            </div>
                            <div class="text-button-uppercase continue mt-4 text-center has-line-before cursor-pointer inline-block">Or continue shopping</div>
                        </div>
                ...
                <div class="container h-full flex items-center w-full">
                    <div class="content-main flex items-center justify-between xl:gap-10 gap-6 w-full max-md:flex-wrap">
                        ...
                        <div class="block-button flex flex-col gap-4 flex-shrink-0">
                            <a href="<?php echo e(route('shop')); ?>" class="button-main whitespace-nowrap"> Compare Products</a>
                    ...
                    <div class="left lg:w-[388px] md:w-[300px] flex-shrink-0 px-6">
                        <div class="list-img max-md:flex items-center gap-4">
                            <div class="bg-img w-full aspect-[3/4] max-md:w-[150px] max-md:flex-shrink-0 rounded-[20px] overflow-hidden md:mt-6">
                                <img src="<?php echo e(asset('assets/images/product/perch-bottal.webp')); ?>" alt="item" class="w-full h-full object-cover" />
                            </div>
                            <div class="bg-img w-full aspect-[3/4] max-md:w-[150px] max-md:flex-shrink-0 rounded-[20px] overflow-hidden md:mt-6">
                                <img src="<?php echo e(asset('assets/images/product/perch-bottal.webp')); ?>" alt="item" class="w-full h-full object-cover" />
                            </div>
                        ...
                        <div class="product-infor">
                            ...
                            <div class="list-action mt-6">
                                <div class="choose-color">
                                    ...
                                    <div class="list-color flex items-center gap-2 flex-wrap mt-3">
                                        <div class="color-item w-12 h-12 rounded-xl duration-300 relative active">
                                            <img src="<?php echo e(asset('assets/images/product/color/48x48.png')); ?>" alt="color" class="rounded-xl" />
                                ...
                                <div class="button-block mt-5">
                                    <a href="<?php echo e(route('shop')); ?>" class="button-main w-full text-center">Buy It Now</a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/home.blade.php ENDPATH**/ ?>