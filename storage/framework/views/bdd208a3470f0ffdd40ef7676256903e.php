<?php $__env->startSection('title', 'Product Sidebar - Perch Bottle'); ?>
...
<div id="menu-mobile" class="">
                                                ...
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 active"> Products With Sidebar </a>
                                                            </li>
                                                            <li>
                ...
                <div class="main bg-surface md:pt-[88px] pt-[70px] pb-[14px]">
                    <div class="container flex items-center justify-between flex-wrap gap-3">
                        <div class="left flex items-center gap-1">
                            ...
                            <i class="ph ph-caret-right text-xs text-secondary2"></i>
                            <div class="caption1 capitalize">Product With Sidebar</div>
                        </div>
        ...
        <div class="product-detail sidebar sale">
            <div class="featured-product underwear filter-product-img md:pt-20 pt-14">
                <div class="container flex justify-between gap-y-6 flex-wrap max-sm:flex-col-reverse">
                    <div class="sidebar lg:w-1/4 sm:w-[40%] lg:pr-12 sm:pr-10 w-full">
                        <div class="filter-type-block pb-7 border-b border-line">
                            ...
                            <div class="list-type filter-type menu-tab mt-4">
                                ...
                                <div class="item tab-item flex items-center justify-between cursor-pointer" data-item="dress">
                                    ...
                                    <div class="text-secondary2 number">3</div>
                                </div>
                                <div class="item tab-item flex items-center justify-between cursor-pointer" data-item="top">
                                    ...
                                    <div class="text-secondary2 number">4</div>
                                </div>
                                <div class="item tab-item flex items-center justify-between cursor-pointer" data-item="swimwear">
                                    ...
                                    <div class="text-secondary2 number">8</div>
                                </div>
                                <div class="item tab-item flex items-center justify-between cursor-pointer" data-item="shirt">
                                    ...
                                    <div class="text-secondary2 number">5</div>
                                </div>
                        ...
                        <div class="benefit pb-7 border-b border-line mt-7">
                            <div class="heading6">Benefit</div>
                            <div class="list mt-4">
                                <div class="item flex gap-4">
                                    <div class="icon-delivery-truck text-4xl"></div>
                                    <div>
                                        <div class="text-title">Free Shipping</div>
                                        <div class="text-secondary mt-1">Free Shipping for orders over $90</div>
                                    </div>
                                </div>
                                <div class="item flex gap-4 mt-5">
                                    <div class="icon-guarantee text-4xl"></div>
                                    <div>
                                        <div class="text-title">Money Back guarantee</div>
                                        <div class="text-secondary mt-1">100% money back guarantee</div>
                                    </div>
                                </div>
                                <div class="item flex gap-4 mt-5">
                                    <div class="icon-phone-call text-4xl"></div>
                                    <div>
                                        <div class="text-title">24/7 online support</div>
                                        <div class="text-secondary mt-1">24 hours a day, 7 days a week</div>
                                    </div>
                                </div>
                                <div class="item flex gap-4 mt-5">
                                    <div class="icon-credit-card text-4xl"></div>
                                    <div>
                                        <div class="text-title">Flexible Payment</div>
                                        <div class="text-secondary mt-1">Pay with Multiple Credit Cards</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mt-8">
                            <div class="heading6">You'll love this too</div>
                            <div class="list">
                                <div class="item flex items-center gap-5 mt-4 cursor-pointer">
                                    <img src="<?php echo e(asset('assets/images/product/1000x1000.png" alt="img" class="w-20 aspect-[3/4] object-cover rounded-lg flex-shrink-0') " />
                                    <div>
                                        <div class="text-title">White Canvas Stripe Trainer</div>
                                        <div class="text-title mt-1">$24.00</div>
                                    </div>
                                </div>
                                <div class="item flex items-center gap-5 mt-4 cursor-pointer">
                                    <img src="{{ asset('assets/images/product/1000x1000.png" alt="img" class="w-20 aspect-[3/4] object-cover rounded-lg flex-shrink-0') " />
                                    <div>
                                        <div class="text-title">White Canvas Stripe Trainer</div>
                                        <div class="text-title mt-1">$32.00</div>
                                    </div>
                                </div>
                                <div class="item flex items-center gap-5 mt-4 cursor-pointer">
                                    <img src="{{ asset('assets/images/product/1000x1000.png" alt="img" class="w-20 aspect-[3/4] object-cover rounded-lg flex-shrink-0') " />
                                    <div>
                                        <div class="text-title">White Canvas Stripe Trainer</div>
                                        <div class="text-title mt-1">$29.00</div>
                                    </div>
                                </div>
                                <div class="item flex items-center gap-5 mt-4 cursor-pointer">
                                    <img src="{{ asset('assets/images/product/1000x1000.png" alt="img" class="w-20 aspect-[3/4] object-cover rounded-lg flex-shrink-0') " />
                    ...
                    <div class="right lg:w-3/4 sm:w-[60%] sm:pl-3 w-full">
                        <div class="flex max-lg:flex-col justify-between gap-y-6">
                            <div class="list-img lg:w-1/2 lg:pr-[40px] w-full">
                                <div class="swiper mySwiper2 rounded-2xl overflow-hidden">
                                    <div class="swiper-wrapper">
                                        <!--  -->
                                    </div>
                                </div>
                                <div class="swiper mySwiper style-rectangle">
                                    <div class="swiper-wrapper">
                                        <!--  -->
                                    </div>
                                </div>
                            ...
                            <div class="product-infor lg:w-1/2 w-full">
                                ...
                                <div class="list-action mt-6">
                                    ...
                                    <div class="flex items-center lg:gap-20 gap-8 mt-5">
                                        <div class="compare flex items-center gap-3 cursor-pointer">
                                            <div class="compare-btn md:w-12 md:h-12 w-10 h-10 flex items-center justify-center border border-line cursor-pointer rounded-xl duration-300 hover:bg-black hover:text-white">
                                                <i class="ph ph-arrows-counter-clockwise heading6"></i>
                                            </div>
                                            <span>Compare</span>
                                        </div>
                                        <div class="share flex items-center gap-3 cursor-pointer">
                                            <div class="share-btn md:w-12 md:h-12 w-10 h-10 flex items-center justify-center border border-line cursor-pointer rounded-xl duration-300 hover:bg-black hover:text-white">
                                                <i class="ph-fill ph-share-network heading6"></i>
                                            </div>
                        ...
                        <div class="desc-tab mt-12">
                            <div class="menu-tab flex items-center lg:gap-[60px] gap-8">
                            ...
                            <div class="desc-block mt-8">
                                ...
                                <div class="desc-item specifications flex items-center" data-item="Specifications">
                                    <div class="lg:w-1/2 sm:w-3/4 w-full">
                                        ...
                                        <div class="item flex items-center gap-8 py-3 px-10">
                                            ...
                                            <p><?php echo e(isset($availableSizes) && count($availableSizes) > 0 ? implode(', ', $availableSizes) : '—'); ?></p>
                                        </div>
                                        <div class="item bg-surface flex items-center gap-8 py-3 px-10">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/product/sidebar.blade.php ENDPATH**/ ?>