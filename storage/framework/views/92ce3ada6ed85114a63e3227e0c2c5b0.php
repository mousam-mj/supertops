<?php $__env->startSection('title', 'Wishlist - Perch Bottle'); ?>
                                            ...
                                            <div class="list-nav-item w-full pt-2 pb-6">
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('wishlist')); ?>" class="link text-secondary duration-300 active"> Wish List </a>
                                                            </li>
                                                            <li>
            ...
            <div class="container">
                <div class="list-product-block">
                    ...
                    <div class="wishlist-empty hidden text-center py-16" id="wishlist-empty-state">
                        ...
                        <a href="<?php echo e(route('shop')); ?>" class="button-main inline-block">Continue Shopping</a>
                    </div>
                </div>
            </div>
        </div>
...
(function() {
    ...
    var origin = (typeof window.location !== 'undefined' && window.location.origin) ? window.location.origin.replace(/\/$/, '') : '<?php echo e(url("")); ?>'.replace(/\/$/, '');
    var baseUrl = origin;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/wishlist.blade.php ENDPATH**/ ?>