<?php $__env->startSection('title', ($category ? $category->name : 'Category') . ' - Perch Bottle'); ?>
...
<div class="list-banner sm:-mt-[75px]">
    ...
    <div class="heading4 absolute bottom-12 left-1/2 -translate-x-1/2 whitespace-nowrap"><?php echo e($category ? $category->name : 'Category'); ?></div>
...
<div class="banner-block relative">
    <div class="list-banner">
        <a href="<?php echo e(route('shop')); ?>" class="banner-item relative bg-surface block overflow-hidden duration-500">
            <div class="banner-img w-full">
        ...
        <div class="banner-block md:pt-20 pt-10">
            <div class="container">
                <div class="list-banner grid md:grid-cols-3 gap-[20px]">
                    <a href="<?php echo e(route('shop')); ?>" class="banner-item relative bg-surface block rounded-[20px] overflow-hidden duration-500">
                        <div class="banner-img w-full">
                ...
                <div class="product-main cursor-pointer block">
                    <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                        ...
                        <div class="product-img w-full h-full aspect-[3/4]">
                            <img class="w-full h-full object-cover duration-700" src="<?php echo e(asset('assets/images/product/perch-bottal.webp')); ?>" alt="img" />
                            <img class="w-full h-full object-cover duration-700" src="<?php echo e(asset('assets/images/product/perch-bottal.webp')); ?>" alt="img" />
                        </div>
                    ...
                    <div class="product-infor mt-4 lg:mb-7">
                        ...
                        <div class="list-color list-color-image max-md:hidden flex items-center gap-3 flex-wrap duration-500">
                            <div class="color-item w-12 h-12 rounded-xl duration-300 relative">
                                <img src="<?php echo e(asset('assets/images/product/perch-bottal.webp')); ?>" alt="color" class="rounded-xl w-full h-full object-cover" />
    ...
    <div class="container">
        <div class="content md:rounded-[28px] rounded-2xl overflow-hidden relative">
            ...
            <div class="text-content xl:w-1/3 w-2/3 xl:pl-[120px] md:pl-20 pl-10 md:py-[85px] py-12">
                ...
                <a href="<?php echo e(route('shop')); ?>" class="button-main md:mt-7 mt-3">Shop Now</a>
            </div>
        </div>
    </div>
</div>
...
<div class="banner-block pt-5 px-5">
    <div class="container">
        <div class="list-banner grid lg:grid-cols-2 sm:grid-cols-2 gap-[20px]">
                <a href="<?php echo e(route('shop')); ?>" class="banner-item relative bg-surface block rounded-[20px] overflow-hidden duration-500">
                    <div class="banner-img w-full">
                        <img src="<?php echo e(asset('assets/images/banner/perch123(2).webp')); ?>" alt="bg-img" class="w-full duration-500">
                    </div>
                ...
                <a href="<?php echo e(route('shop')); ?>" class="banner-item relative bg-surface block rounded-[20px] overflow-hidden duration-500">
                    ...
                    <div class="banner-content absolute left-[30px] bottom-[30px]">
                        <div class="heading4"><?php echo e($category ? $category->name : 'Category'); ?></div>
                        <div class="text-button text-black relative inline-block pb-1 border-b-2 border-black duration-500 mt-2">Shop Now</div>
                    </div>
                </a>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/category.blade.php ENDPATH**/ ?>