<?php $__env->startSection('title', 'Product Style1 - Perch Bottle'); ?>
                                            ...
                                            <div class="list-nav-item w-full pt-2 pb-6">
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer active"> Products Style 01 </a>
                                                            </li>
                                                            <li>
                    ...
                    <div class="main-content w-full h-full flex flex-col items-center justify-center relative z-[1]">
                        <div class="text-content">
                            ...
                            <div class="link flex items-center justify-center gap-1 caption1 mt-3">
                                ...
                                <div class="text-secondary2 capitalize">Product Style 01</div>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/product/style1.blade.php ENDPATH**/ ?>