<?php $__env->startSection('title', 'Shop Default Grid - Perch Bottle'); ?>
                                                ...
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('shop')); ?>" class="link text-secondary duration-300 cursor-pointer active"> Shop Default Grid </a>
                                                            </li>
                                                            <li>
                        ...
                        <div class="filter-heading flex items-center justify-between gap-5 flex-wrap">
                            <div class="left flex has-line items-center flex-wrap gap-5">
                                <div class="choose-layout menu-tab flex items-center gap-2">
                                    ...
                                    <a href="<?php echo e(route('shop')); ?>" class="item row w-8 h-8 border border-line rounded flex items-center justify-center cursor-pointer">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/shop/grid.blade.php ENDPATH**/ ?>