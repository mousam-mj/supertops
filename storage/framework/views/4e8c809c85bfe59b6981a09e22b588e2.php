<?php $__env->startSection('title', 'Checkout2 - Perch Bottle'); ?>
                    ...
                    <div class="lg:max-w-[716px] flex-shrink-0 w-full lg:pt-20 pt-12 lg:pr-[70px] pl-[16px] max-lg:pr-[16px]">
                        <form>
                            <div class="login flex justify-between gap-4">
                                ...
                                <a href="<?php echo e(route('login')); ?>" class="text-button underline">Login here</a>
                            </div>
                            <div>
                        ...
                        <div class="copyright caption1 md:mt-20 mt-12 py-3 border-t border-line">©<?php echo e(date('Y')); ?> Anvogue. All Rights Reserved.</div>
                    </div>
                </div>
                            ...
                            <div class="item flex items-center justify-between gap-6">
                                <div class="flex items-center gap-6">
                                    <div class="bg_img relative flex-shrink-0 w-[100px] h-[100px]">
                                        <img src="<?php echo e(asset('assets/images/product/1000x1000.png" alt="product/1000x1000" class="w-full h-full object-cover rounded-lg') " />
                    ...
                    <div class="footer-modal bg-white absolute bottom-0 left-0 w-full">
                        ...
                        <div class="block-button text-center p-6">
                            <div class="flex items-center gap-4">
                                ...
                                <a href="<?php echo e(route('checkout.index')); ?>" class="button-main basis-1/2 text-center uppercase"> Check Out </a>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/checkout/index2.blade.php ENDPATH**/ ?>