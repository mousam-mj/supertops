<?php $__env->startSection('title', 'Product Grouped - Perch Bottle'); ?>
...
<div id="menu-mobile" class="">
                                                ...
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 active"> Products Grouped </a>
                                                            </li>
                                                            <li>
                ...
                <div class="main bg-surface md:pt-[88px] pt-[70px] pb-[14px]">
                    <div class="container flex items-center justify-between flex-wrap gap-3">
                        <div class="left flex items-center gap-1">
                            ...
                            <i class="ph ph-caret-right text-xs text-secondary2"></i>
                            <div class="caption1 capitalize">Product Grouped</div>
                        </div>
        ...
        <div class="product-detail grouped style-grouped">
                    ...
                    <div class="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
                        <div class="sticky">
                            ...
                            <div class="list-group mt-1">
                                <div class="item flex items-center justify-between mt-6 pb-6 border-b border-line">
                                    <div class="left flex items-center sm:gap-5 gap-3">
                                        <div class="bg-img w-[95px] aspect-[3/4] flex-shrink-0">
                                            <img src="<?php echo e(asset('assets/images/product/1000x1000.png" alt="img" class="w-full h-full object-cover rounded-lg') " />
                                        </div>
                                        <div class="infor">
                                            <div class="text-title">Black Canvas Stripe Trainer</div>
                                            <div class="select-block relative w-fit mt-2">
                                                <select class="text-button sm:py-2 py-1.5 sm:pl-3 pl-2 sm:pr-8 pr-6 rounded-lg bg-white border border-line">
                                            ...
                                            <div class="text-title mt-2">$50.00</div>
                                        </div>
                                    </div>
                                    <div class="right">
                                ...
                                <div class="item flex items-center justify-between mt-6 pb-6 border-b border-line">
                                    <div class="left flex items-center sm:gap-5 gap-3">
                                        <div class="bg-img w-[95px] aspect-[3/4] flex-shrink-0">
                                            <img src="{{ asset('assets/images/product/1000x1000.png" alt="img" class="w-full h-full object-cover rounded-lg') " />
                                        </div>
                                        <div class="infor">
                                            <div class="text-title">Black Canvas Stripe Trainer</div>
                                            <div class="select-block relative w-fit mt-2">
                            ...
                            <div class="list-action mt-6">
                                <div class="flex items-center gap-3 flex-wrap">
                                    <div class="text-title">Total Price:</div>
                                    <div class="product-total-price heading3">$180.00</div>
                                ...
                                <div class="grid grid-cols-2 xl:gap-5 gap-3 sm:mt-6 mt-4">
                                    <div class="add-cart-btn button-main whitespace-nowrap text-center bg-white text-black border border-black">Add To Cart</div>
                                    <div class="button-main text-center">Buy It Now</div>
                                </div>
                            ...
                            <div class="desc-tab">
                                <div class="desc-block sm:pb-6 pb-4 border-b border-line sm:mt-6 mt-4">
                                    <div class="flex items-center justify-between w-full cursor-pointer">
                                        <div class="tab-item heading5 hover:text-black duration-300 active">Description</div>
                                    ...
                                    <div class="desc-item description" data-item="Description">
                                        ...
                                        <div class="grid grid-cols-2 gap-[30px] md:mt-8 mt-5">
                                            <div class="item">
                                                <div class="icon-delivery-truck text-4xl"></div>
                                ...
                                <div class="desc-block sm:pb-6 pb-4 border-b border-line sm:mt-6 mt-4">
                                    <div class="flex items-center justify-between w-full cursor-pointer">
                                        <div class="tab-item heading5 hover:text-black duration-300">Specifications</div>
                                        <i class="ph ph-caret-down text-2xl"></i>
                                    </div>
                                    <div class="desc-item specifications flex items-center justify-center" data-item="Specifications">
                                        <div class="lg:w-1/2 sm:w-3/4 w-full mt-4">
                                ...
                                <div class="desc-block sm:pb-6 pb-4 sm:mt-6 mt-4">
                                    <div class="flex items-center justify-between w-full cursor-pointer">
                                        <div class="tab-item heading5 hover:text-black duration-300">Review</div>
                                        <i class="ph ph-caret-down text-2xl"></i>
                                    </div>
                                    <div class="desc-item review" data-item="Review">
                                        <div class="top-overview mt-4">
                                            <div class="left flex max-sm:flex-col gap-y-4 items-center justify-between w-full">
                                            ...
                                            <div class="right max-sm:text-center mt-6">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/product/grouped.blade.php ENDPATH**/ ?>