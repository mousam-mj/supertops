<?php $__env->startSection('title', 'Product Out Of Stock - Perch Bottle'); ?>
...
<div id="menu-mobile" class="">
                                                ...
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 active"> Products Out Of Stock </a>
                                                            </li>
                                                            <li>
                ...
                <div class="main bg-surface md:pt-[88px] pt-[70px] pb-[14px]">
                    <div class="container flex items-center justify-between flex-wrap gap-3">
                        <div class="left flex items-center gap-1">
                            ...
                            <i class="ph ph-caret-right text-xs text-secondary2"></i>
                            <div class="caption1 capitalize">Product Out Of Stock</div>
                        </div>
        ...
        <div class="product-detail out-of-stock style-grouped">
            <div class="featured-product underwear md:py-20 py-14">
                <div class="container flex justify-between gap-y-6 flex-wrap">
                    ...
                    <div class="product-infor style-out-of-stock md:w-1/2 w-full lg:pl-[15px] md:pl-2">
                        <div class="sticky">
                            ...
                            <div class="list-action mt-6">
                                <div class="choose-color mt-5">
                                    <div class="text-title">Colors: <span class="text-title color">Out of stock</span></div>
                                ...
                                <div class="choose-size mt-5">
                                    <div class="heading flex items-center justify-between">
                                        <div class="text-title">Size: <span class="text-title size">Out of stock</span></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/product/out-of-stock.blade.php ENDPATH**/ ?>