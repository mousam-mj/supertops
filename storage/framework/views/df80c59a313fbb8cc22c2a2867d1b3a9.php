<?php $__env->startSection('title', 'Product Style4 - Perch Bottle'); ?>
                                                ...
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 cursor-pointer active"> Products Style 04 </a>
                                                            </li>
                                                            <li>
                    ...
                    <div class="main-content w-full h-full flex flex-col items-center justify-center relative z-[1]">
                        <div class="text-content">
                            ...
                            <div class="link flex items-center justify-center gap-1 caption1 mt-3">
                                ...
                                <div class="text-secondary2 capitalize">Product Style 04</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="shop-product lg:py-20 md:py-14 py-10">
            <div class="container">
                <div class="list-product hide-product-sold grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 sm:gap-[30px] gap-5">
                    <div class="product-item grid-type style-4" data-item="1">
                        <div class="product-main cursor-pointer block">
                            <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                ...
                                <div class="list-action-right absolute top-3 right-3">
                                    <div class="add-cart-btn w-[32px] h-[32px] flex items-center justify-center rounded-full bg-white duration-300 relative">
                                        <div class="tag-action bg-black text-white caption2 px-1.5 py-0.5 rounded-sm">Add To Cart</div>
                                        <i class="ph ph-shopping-bag-open text-xl"></i>
                                    </div>
                                    <div class="add-wishlist-btn w-[32px] h-[32px] flex items-center justify-center rounded-full bg-white duration-300 relative mt-2">
                                ...
                                <div class="list-size-blur flex items-center justify-center gap-4 absolute bottom-0 left-0 w-full h-8">
                                    <strong class="item text-xs font-bold uppercase">S</strong>
                                    <strong class="item text-xs font-bold uppercase">M</strong>
                                    <strong class="item text-xs font-bold uppercase">L</strong>
                                    <strong class="item text-xs font-bold uppercase">XL</strong>
                                </div>
                            </div>
                    ...
                    <div class="product-item grid-type style-4" data-item="3">
                        <div class="product-main cursor-pointer block">
                            <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                    ...
                    <div class="product-item grid-type style-4" data-item="4">
                        <div class="product-main cursor-pointer block">
                            <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                <div class="product-tag text-button-uppercase text-white bg-red px-3 py-0.5 inline-block rounded-full absolute top-3 left-3 z-[1]">Sale</div>
                                <div class="list-action-right absolute top-3 right-3">
                    ...
                    <div class="product-item grid-type style-4" data-item="5">
                        <div class="product-main cursor-pointer block">
                            <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                <div class="product-tag text-button-uppercase bg-green px-3 py-0.5 inline-block rounded-full absolute top-3 left-3 z-[1]">New</div>
                                <div class="list-action-right absolute top-3 right-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/product/style4.blade.php ENDPATH**/ ?>