<?php $__env->startSection('title', 'Shop Sidebar List - Perch Bottle'); ?>
            ...
            <div class="container">
                <div class="flex max-md:flex-wrap max-md:flex-col-reverse gap-y-8">
                    ...
                    <div class="list-product-block style-list lg:w-3/4 md:w-2/3 w-full md:pl-3">
                        ...
                        <div class="list-product hide-product-sold flex flex-col gap-8 mt-7" data-item="4"></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/shop/sidebar-list.blade.php ENDPATH**/ ?>