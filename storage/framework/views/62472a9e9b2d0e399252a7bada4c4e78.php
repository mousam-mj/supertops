...
<head>
    ...
    <title>Order Confirmation - <?php echo e($order->order_number); ?></title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background-color: #fff; padding: 30px; margin-top: 20px;">
        ...
        <div style="background-color: #f9f9f9; padding: 15px; margin: 20px 0; border-left: 4px solid #333;">
            ...
            <p><strong>Order Date:</strong> <?php echo e($order->created_at->format('F d, Y')); ?></p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #ddd;"><?php echo e($item->product->name ?? $item->product_name); ?></td>
                    <td style="padding: 10px; text-align: center; border-bottom: 1px solid #ddd;"><?php echo e($item->quantity); ?></td>
                    <td style="padding: 10px; text-align: right; border-bottom: 1px solid #ddd;">₹<?php echo e(number_format($item->price * $item->quantity, 2)); ?></td>
                </tr>
        ...
        <div style="background-color: #f9f9f9; padding: 15px; margin: 20px 0;">
            <div style="display: flex; justify-content: space-between; margin: 5px 0;">
                <span>Subtotal:</span>
                <span>₹<?php echo e(number_format($order->total_amount - $order->shipping_charge - ($order->coupon_discount ?? 0), 2)); ?></span>
            </div>
            <div style="display: flex; justify-content: space-between; margin: 5px 0;">
                <span>Shipping:</span>
        ...
        <p>
            <?php echo e($order->shipping_address['full_name'] ?? ''); ?><br>
            <?php echo e($order->shipping_address['address_line_1'] ?? ''); ?><br>
            <?php if(!empty($order->shipping_address['address_line_2'])): ?>
                <?php echo e($order->shipping_address['address_line_2']); ?><br>
            <?php endif; ?>
            ...
            Phone: <?php echo e($order->shipping_address['phone'] ?? ''); ?>
...
<?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/emails/order-confirmation.blade.php ENDPATH**/ ?>