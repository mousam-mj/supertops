<?php $__env->startSection('title', 'Color & Size Master'); ?>
<?php $__env->startSection('page-title', 'Color & Size Master'); ?>
...
<div class="row">
    ...
    <div class="col-lg-6 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.color-size-master.store-color')); ?>" method="POST" class="mb-4" id="form-add-color">
                    <?php echo csrf_field(); ?>
                    <div class="row g-3 align-items-end">
                        <div class="col-12 col-sm col-md-4">
                            <label class="form-label small mb-1">Color name</label>
                            <input type="text" name="name" class="form-control form-control-sm" placeholder="e.g. Red, Blue" value="<?php echo e(old('name')); ?>" required>
                        </div>
                        <div class="col-12 col-sm col-md-4">
                            <label class="form-label small mb-1">Color code (hex) or pick</label>
                            <div class="d-flex gap-1 align-items-center flex-nowrap">
                                <input type="text" name="color_code" id="color_code_input" class="form-control form-control-sm" placeholder="#FF0000" value="<?php echo e(old('color_code')); ?>" maxlength="20" title="e.g. #FF0000 or #F00 (optional)">
                        ...
                        <div class="col-6 col-sm-auto">
                            ...
                            <input type="number" name="sort_order" class="form-control form-control-sm" placeholder="0" value="<?php echo e(old('sort_order', 0)); ?>" min="0" style="width: 5rem;">
                        </div>
                                        ...
                                        <td>
                                            <?php if($color->color_code): ?>
                                                <span class="d-inline-flex align-items-center gap-2">
                                                    <span class="d-inline-block rounded border" style="width:24px;height:24px;background:<?php echo e($color->color_code); ?>;" title="<?php echo e($color->color_code); ?>"></span>
                                                    <span class="small text-muted"><?php echo e($color->color_code); ?></span>
                                                </span>
                                            <?php else: ?>
                                                <span class="text-muted small">—</span>
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e($color->sort_order); ?></td>
                                        <td>
                                            <form action="<?php echo e(route('admin.color-size-master.destroy-color', $color)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Delete this color?');">
                                                <?php echo csrf_field(); ?>
    ...
    <div class="col-lg-6 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.color-size-master.store-size')); ?>" method="POST" class="row g-2 mb-4">
                    <?php echo csrf_field(); ?>
                    <div class="col-auto flex-grow-1">
                        <input type="text" name="name" class="form-control form-control-sm" placeholder="Add new size (e.g. S, M, L, 32GB)" value="<?php echo e(old('name')); ?>" required>
                    </div>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="<?php echo e(route('admin.color-size-master.destroy-size', $size)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Delete this size?');">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button type="submit" class="btn btn-sm btn-outline-danger" title="Delete"><i class="bi bi-trash"></i></button>
                                            </form>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/admin/color-size-master/index.blade.php ENDPATH**/ ?>