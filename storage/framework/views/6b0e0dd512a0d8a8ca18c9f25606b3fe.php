<?php $__env->startSection('title', 'Product Bought Together - Perch Bottle'); ?>
                                                ...
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 active"> Frequently Bought Together </a>
                                                            </li>
                                                            <li>
                ...
                <div class="main bg-surface md:pt-[88px] pt-[70px] pb-[14px]">
                    <div class="container flex items-center justify-between flex-wrap gap-3">
                        <div class="left flex items-center gap-1">
                            ...
                            <i class="ph ph-caret-right text-xs text-secondary2"></i>
                            <div class="caption1 capitalize">Product Bought Together</div>
                        </div>
            ...
            <div class="featured-product countdown-timer underwear md:py-20 py-14">
                <div class="container flex justify-between gap-y-6 flex-wrap">
                    <div class="list-img md:w-1/2 md:pr-[45px] w-full flex-shrink-0">
                        <div class="sticky">
                            <div class="list grid grid-cols-2 gap-5">
                                <!-- list img -->
                            </div>
                        </div>
                    ...
                    <div class="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
                        <div class="">
                            ...
                            <div class="get-it pb-8 border-b border-line mt-6">
                            ...
                            <div class="list-bought-together mt-6">
                                <div class="heading5">Frequently bought together</div>
                                <div class="list-product-img flex gap-3 mt-4">
                                    <img src="<?php echo e(asset('assets/images/product/1000x1000.png" alt="img" class="w-[100px] aspect-[3/4] object-cover rounded-lg') " />
                                    <img src="{{ asset('assets/images/product/1000x1000.png" alt="img" class="w-[100px] aspect-[3/4] object-cover rounded-lg') " />
                                    <img src="{{ asset('assets/images/product/1000x1000.png" alt="img" class="w-[100px] aspect-[3/4] object-cover rounded-lg') " />
                                </div>
                                <div class="list-infor mt-2">
                                    <div class="item flex items-center gap-3 mt-4">
                                        <div class="flex items-center gap-2">
                                            <input type="checkbox" name="item1" id="item1" />
                                            <label for="item1" class="text-title">Message cotton sweatshirt</label>
                                        </div>
                                        <div class="select-block relative w-fit">
                                            <select class="caption1 py-1 pl-2 pr-8 rounded-lg bg-white border border-line">
                                        ...
                                        <div class="price text-title">$32.00</div>
                                    </div>
                                    <div class="item flex items-center gap-3 mt-4">
                                        <div class="flex items-center gap-2">
                                            <input type="checkbox" name="item2" id="item2" />
                                            <label for="item2" class="text-title">Contrasting sheepskin sweatshirt</label>
                                        </div>
                                        <div class="select-block relative w-fit">
                                            <select class="caption1 py-1 pl-2 pr-8 rounded-lg bg-white border border-line">
                                                <option value="S - Green">S - Green</option>
                                        ...
                                        <div class="price text-title">$28.00</div>
                                    </div>
                                    <div class="item flex items-center gap-3 mt-4">
                                        <div class="flex items-center gap-2">
                                            <input type="checkbox" name="item3" id="item3" />
                                            <label for="item3" class="text-title">Leather boots with tall leg</label>
                                        </div>
                                        <div class="select-block relative w-fit">
                                            <select class="caption1 py-1 pl-2 pr-8 rounded-lg bg-white border border-line">
                                                <option value="S - Green">S - Green</option>
                                        ...
                                        <div class="price text-title">$30.00</div>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 flex-wrap mt-4">
                                    <div class="text-title">Total Price:</div>
                                    <div class="product-total-price heading3">$105.00</div>
                                    <div class="w-px h-4 bg-line"></div>
                                    <div class="product-origin-price font-normal text-secondary2">
                                        <del>$135.00</del>
                                    </div>
                                    <div class="product-sale caption2 font-semibold bg-green px-3 py-0.5 inline-block rounded-full">-24%</div>
                                </div>
                                <div class="add-cart-btn button-main whitespace-nowrap text-center bg-black mt-6">Add Both To Cart</div>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/product/bought-together.blade.php ENDPATH**/ ?>