...
?>
<?php if($categoryCards->isNotEmpty()): ?>
    ...
    <div class="container">
        ...
        <div class="list-banner grid sm:grid-cols-2 md:grid-cols-3 gap-5 md:gap-[20px] mt-8">
            <?php $__currentLoopData = $categoryCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <a href="<?php echo e(route('frontend.range', ['category' => $category->slug])); ?>"
                   class="banner-ads-item block bg-linear rounded-2xl relative overflow-hidden cursor-pointer edxpro border border-line no-underline text-inherit">
                    <div class="text-content relative z-[1] py-10 md:py-12 pl-6 md:pl-8 pr-[36%] md:pr-32">
                        <div class="heading4 mt-2 text-black"><?php echo e($category->name); ?></div>
                        <div class="body1 mt-3 text-secondary"><?php echo e($desc); ?></div>
                    ...
                    <img src="<?php echo e($imgUrl); ?>" alt="<?php echo e($category->name); ?>" class="w-[36%] md:w-[40%] absolute right-0 top-0 object-contain object-right-top pointer-events-none" loading="lazy" width="200" height="200">
                </a>
...
<?php endif; ?>
<?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/frontend/partials/edx-product-category.blade.php ENDPATH**/ ?>