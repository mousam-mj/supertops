<?php $__env->startSection('title', 'Product Fixed Price - Perch Bottle'); ?>
...
<div id="menu-mobile" class="">
                                                ...
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 active"> Products Fixed Price </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="nav-item">
                ...
                <div class="main bg-surface md:pt-[88px] pt-[70px] pb-[14px]">
                    <div class="container flex items-center justify-between flex-wrap gap-3">
                        <div class="left flex items-center gap-1">
                            ...
                            <i class="ph ph-caret-right text-xs text-secondary2"></i>
                            <div class="caption1 capitalize">Product Fixed Price</div>
                        </div>
        ...
        <div class="product-detail fixed-price md:pt-20 pt-10">
            <div class="featured-product fixed-price underwear">
                <div class="container">
                    <div class="list-img">
                        <div class="list grid md:grid-rows-2 md:grid-cols-3 grid-cols-2 lg:gap-[30px] gap-4 w-full">
                            <!-- list img -->
                        </div>
                ...
                <div class="container flex max-md:flex-col-reverse justify-between gap-y-6 flex-wrap md:py-20 py-10">
                    <div class="desc-tab md:w-1/2 md:pr-[45px] w-full">
                        ...
                        <div class="desc-block sm:pb-6 pb-4 border-b border-line sm:mt-8 mt-6">
                    ...
                    <div class="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
                        <div class="sticky bg-white lg:p-10 p-6 lg:rounded-3xl rounded-2xl box-shadow-sm">
                            ...
                            <div class="list-action mt-6">
                                ...
                                <div class="more-infor mt-6">
                                    ...
                                    <div class="flex items-center flex-wrap gap-1 mt-3">
                                        ...
                                        <div class="text-title whitespace-nowrap">Estimated Delivery:</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/product/fixed-price.blade.php ENDPATH**/ ?>