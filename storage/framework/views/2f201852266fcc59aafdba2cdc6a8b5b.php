<?php $__env->startSection('title', 'Cart - Perch Bottle'); ?>
                    ...
                    <div class="xl:w-1/3 xl:pl-12 w-full">
                        <div class="checkout-block bg-surface p-6 rounded-2xl">
                            ...
                            <div class="block-button flex flex-col items-center gap-y-4 mt-5">
                                <form action="<?php echo e(route('checkout.index')); ?>" method="GET" id="checkout-form" style="width: 100%; margin: 0;">
                                ...
                                <a id="continue-shopping-link" class="text-button hover-underline block text-center" href="<?php echo e(route('shop')); ?>">Continue shopping </a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/cart/index.blade.php ENDPATH**/ ?>