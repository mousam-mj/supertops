<?php $__env->startSection('title', 'Product Thumbnail Bottom - Perch Bottle'); ?>
                ...
                <div class="main bg-surface md:pt-[88px] pt-[70px] pb-[14px]">
                    <div class="container flex items-center justify-between flex-wrap gap-3">
                        <div class="left flex items-center gap-1">
                            ...
                            <i class="ph ph-caret-right text-xs text-secondary2"></i>
                            <div class="caption1 capitalize">Product Thumbnail Bottom</div>
                        </div>
            ...
            <div class="review-block md:py-20 py-10 bg-surface">
                <div class="container">
                    <div class="heading flex items-center justify-between flex-wrap gap-4">
                        ...
                        <div class="right flex items-center gap-3">
                            <label for="select-filter" class="capitalize">Sort by:</label>
                    ...
                    <div class="top-overview flex justify-between py-6 max-lg:flex-col gap-y-10">
                        <div class="rating black-start lg:w-5/12 w-full">
                            <div class="heading flex items-center justify-between gap-12 gap-y-4">
                        ...
                        <div class="list-review lg:w-7/12 lg:pl-[60px]">
                            <div class="item pb-6 border-b border-line">
                                <div class="heading flex items-center justify-between">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/product/thumbnail-bottom.blade.php ENDPATH**/ ?>