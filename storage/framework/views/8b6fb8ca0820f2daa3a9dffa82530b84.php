<?php $__env->startSection('title', 'Privacy Policy - Perch Bottle'); ?>
        ...
        <div class="container">
            <div class="content max-w-4xl mx-auto">
                <div class="body1 text-secondary space-y-6">
                    <?php $privacyContent = \App\Models\Setting::get('privacy_policy'); ?>
                    <?php if($privacyContent): ?>
                        <?php echo nl2br(e($privacyContent)); ?>
                    ...
                    <p>We are the manufacturers of stainless steel bottles and lunchboxes under the brand name Perch. Our one and only official website address is: <a href="<?php echo e(route('home')); ?>" class="text-button hover:underline"><?php echo e(url('/')); ?></a>. Refrain from purchasing or surfing through any other website posing to be us.</p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/privacy-policy.blade.php ENDPATH**/ ?>