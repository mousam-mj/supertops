<?php $__env->startSection('title', 'Product On Sale - Perch Bottle'); ?>
...
<div id="menu-mobile" class="">
                                                ...
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('product.show', $product->slug ?? '#')); ?>" class="link text-secondary duration-300 active"> Products On Sale </a>
                                                            </li>
                                                            <li>
                ...
                <div class="main bg-surface md:pt-[88px] pt-[70px] pb-[14px]">
                    <div class="container flex items-center justify-between flex-wrap gap-3">
                        <div class="left flex items-center gap-1">
                            ...
                            <i class="ph ph-caret-right text-xs text-secondary2"></i>
                            <div class="caption1 capitalize">Product On Sale</div>
                        </div>
        ...
        <div class="product-detail on-sale style-grouped">
            <div class="featured-product on-sale underwear">
                <div class="list-img">
                    <div class="swiper swiper-img-on-sale rounded-2xl overflow-hidden">
                ...
                <div class="container flex justify-between gap-y-6 flex-wrap md:py-20 py-14">
                    <div class="desc-tab md:w-1/2 md:pr-[45px] w-full">
                        <div class="desc-block sm:pb-6 pb-4 border-b border-line sm:mt-6 mt-4">
                            <div class="flex items-center justify-between w-full cursor-pointer">
                                <div class="tab-item heading5 hover:text-black duration-300">Description</div>
                        ...
                        <div class="desc-block sm:pb-6 pb-4 sm:mt-6 mt-4">
                            <div class="flex items-center justify-between w-full cursor-pointer">
                                <div class="tab-item heading5 hover:text-black duration-300 active">Review</div>
                                <i class="ph ph-caret-down text-2xl"></i>
                            </div>
                                    ...
                                    <div class="item mt-6 pb-6 border-b border-line">
                                        <div class="heading flex items-center justify-between">
                                            <div class="user-infor flex gap-4">
                                                <div class="avatar">
                                                    <img src="<?php echo e(asset('assets/images/avatar/1.png" alt="img" class="w-[52px] aspect-square rounded-full') " />
                                                </div>
                                                <div class="user">
                                                    <div class="flex items-center gap-2">
                    ...
                    <div class="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
                        ...
                        <div class="list-action mt-6">
                            <div class="countdown-block flex items-center justify-between flex-wrap gap-y-4">
                                <div class="text-title">
                                    Hurry Up!<br />
                                    Offer ends in:
                                </div>
                                <div class="countdown-time flex items-center lg:gap-5 gap-3 max-[400px]:justify-between max-[400px]:w-full">
                                    <div class="item w-[60px] h-[60px] flex flex-col items-center justify-center border border-red rounded-lg">
                                        <div class="days heading6 text-center">12</div>
                                        <div class="caption1 text-center">Days</div>
                                    </div>
                                    <div class="heading5">:</div>
                                    <div class="item w-[60px] h-[60px] flex flex-col items-center justify-center border border-red rounded-lg">
                                        <div class="hours heading6 text-center">23</div>
                                        <div class="caption1 text-center">Hours</div>
                                    </div>
                                    <div class="heading5">:</div>
                                    <div class="item w-[60px] h-[60px] flex flex-col items-center justify-center border border-red rounded-lg">
                                        <div class="mins heading6 text-center">46</div>
                                        <div class="caption1 text-center">Mins</div>
                                    </div>
                                    <div class="heading5">:</div>
                                    <div class="item w-[60px] h-[60px] flex flex-col items-center justify-center border border-red rounded-lg">
                                        <div class="secs heading6 text-center">32</div>
                                        <div class="caption1 text-center">Secs</div>
                                    </div>
                                </div>
                            </div>
                            <div class="sold-block flex justify-between flex-wrap gap-4 mt-5">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/product/on-sale.blade.php ENDPATH**/ ?>