<?php $__env->startSection('title', 'Blog Detail2 - Perch Bottle'); ?>
                                        ...
                                        <div class="sub-nav-mobile">
                                            ...
                                            <div class="list-nav-item w-full pt-2 pb-6">
                                                <ul class="w-full">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo e(route('home')); ?>" class="link text-secondary duration-300 active"> Blog Detail 2 </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <div class="main xl:w-3/4 lg:w-2/3 lg:pr-[15px]">
                        ...
                        <div class="author flex items-center gap-4 mt-4">
                            <div class="avatar w-10 h-10 rounded-full overflow-hidden flex-shrink-0">
                                <img src="<?php echo e(asset('assets/images/avatar/1.png" alt="avatar" class="w-full h-full object-cover') " />
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/blog/show2.blade.php ENDPATH**/ ?>