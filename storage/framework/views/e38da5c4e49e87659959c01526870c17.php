<?php $__env->startSection('title', 'Reset Password - Perch Bottle'); ?>
        ...
        <div class="container max-w-xl mx-auto">
            <div class="p-6 border border-line rounded-lg">
                ...
                <div class="mt-4 text-center">
                    <a href="<?php echo e(route('forgot-password')); ?>" class="text-button hover:underline">Back to Forgot Password</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/auth/reset-password.blade.php ENDPATH**/ ?>