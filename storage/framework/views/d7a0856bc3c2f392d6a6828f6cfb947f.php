...
<html lang="en">
    <head>
        ...
        <title><?php echo $__env->yieldContent('title', 'Perch Bottle'); ?></title>
        <link rel="shortcut icon" href="<?php echo e(asset('favicon.ico')); ?>" type="image/x-icon" />
        <link rel="icon" href="<?php echo e(asset('favicon.ico')); ?>" type="image/x-icon" />
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/swiper-bundle.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/style.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dist/output-scss.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dist/output-tailwind.css')); ?>" />
...
<body>
    ...
    <script>window.STORAGE_PATH = '<?php echo e(ltrim(parse_url(config("filesystems.disks.public.url"), PHP_URL_PATH) ?? "/storage", "/")); ?>';</script>
    ...
    (function(){
        function openCart() {
            ...
            else location.href='<?php echo e(route("cart.index")); ?>';
        }
        function openWishlist() {
            ...
            else location.href='<?php echo e(route("wishlist")); ?>';
        }
        function openSearch() {
    ...
    <?php if(session('warning')): ?>
        <div class="bg-yellow-500 text-black py-3 px-4 text-center relative z-50" id="session-warning">
            <div class="container mx-auto flex items-center justify-between">
                <div class="flex-1 text-center">
                    <span class="font-semibold">⚠️ <?php echo e(session('warning')); ?></span>
                    <?php if(session('email_sent') === false): ?>
                        <form method="POST" action="<?php echo e(route('email.resend')); ?>" class="inline-block ml-4">
                            <?php echo csrf_field(); ?>
    ...
    <?php if(session('info')): ?>
        <div class="bg-blue-500 text-white py-3 px-4 text-center relative z-50" id="session-info">
            <div class="container mx-auto flex items-center justify-between">
                <div class="flex-1 text-center">
                    <span class="font-semibold">ℹ️ <?php echo e(session('info')); ?></span>
                </div>
    ...
    <div class="modal-search-block">
        <div class="modal-search-main md:p-10 p-6 rounded-[32px] relative">
            ...
            <div class="form-search relative w-full">
                <form method="GET" action="<?php echo e(route('search')); ?>" id="searchModalForm">
            ...
            <div class="keyword mt-8">
                ...
                <div class="list-keyword flex items-center flex-wrap gap-3 mt-4">
                    <button type="button" class="item px-4 py-1.5 border border-line rounded-full cursor-pointer duration-300 hover:bg-black hover:text-white" onclick="window.location.href='<?php echo e(route('search', ['q' => 'Dress'])); ?>'">Dress</button>
                    <button type="button" class="item px-4 py-1.5 border border-line rounded-full cursor-pointer duration-300 hover:bg-black hover:text-white" onclick="window.location.href='<?php echo e(route('search', ['q' => 'T-shirt'])); ?>'">T-shirt</button>
                    <button type="button" class="item px-4 py-1.5 border border-line rounded-full cursor-pointer duration-300 hover:bg-black hover:text-white" onclick="window.location.href='<?php echo e(route('search', ['q' => 'Bottle'])); ?>'">Bottle</button>
                    <button type="button" class="item px-4 py-1.5 border border-line rounded-full cursor-pointer duration-300 hover:bg-black hover:text-white" onclick="window.location.href='<?php echo e(route('search', ['q' => 'Top'])); ?>'">Top</button>
                </div>
            </div>
            <div class="search-results-dynamic mt-8" id="searchModalResults">
                ...
                <a href="<?php echo e(route('search')); ?>" class="button-main w-full text-center mt-4 hidden" id="searchModalViewAll">View all results</a>
            </div>
        </div>
    </div>
    ...
    <div class="modal-wishlist-block">
        <div class="modal-wishlist-main py-6">
            ...
            <div class="footer-modal p-6 border-t bg-white border-line absolute bottom-0 left-0 w-full text-center">
                <a href="<?php echo e(route('wishlist')); ?>" class="button-main w-full text-center uppercase block"> View All Wish List</a>
                <a href="<?php echo e(route('shop')); ?>" class="text-button-uppercase continue mt-2 text-center has-line-before cursor-pointer inline-block block">Continue shopping</a>
            </div>
        </div>
    </div>
        ...
        <div class="modal-cart-main flex">
            ...
            <div class="right cart-block md:w-1/2 w-full py-6 relative overflow-hidden">
                ...
                <div class="footer-cart p-6 border-t border-line bg-white absolute bottom-0 left-0 w-full">
                    ...
                    <a href="<?php echo e(route('checkout.index')); ?>" class="button-main w-full text-center uppercase">Checkout</a>
                    <a href="<?php echo e(route('cart.index')); ?>" class="button-main w-full text-center uppercase mt-3 bg-white border border-black text-black hover:bg-black hover:text-white">View Cart</a>
                </div>
            </div>
        </div>
    </div>
                ...
                searchInput.addEventListener('input', function() {
                    ...
                    if (q.length >= 2) {
                        ...
                        searchTimeout = setTimeout(function() {
                            fetch('<?php echo e(url("/search/ajax")); ?>?q=' + encodeURIComponent(q))
                                .then(r => r.text())
                                .then(html => {
                                    ...
                                    searchViewAll.href = '<?php echo e(url("/search")); ?>?q=' + encodeURIComponent(q);
...
<?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/layouts/app.blade.php ENDPATH**/ ?>