<?php $__env->startSection('title', 'Product Discount - Perch Bottle'); ?>
                ...
                <div class="main bg-linear md:pt-[88px] pt-[70px] pb-[14px]">
                    <div class="container flex items-center justify-between flex-wrap gap-3">
                        <div class="left flex items-center gap-1">
                            ...
                            <i class="ph ph-caret-right text-xs text-secondary2"></i>
                            <div class="caption1 capitalize"><?php echo e($product->name); ?></div>
                        </div>
                        <div class="right flex items-center gap-3">
                            <?php if($prevProduct): ?>
                                <a href="<?php echo e(route('product.show', $prevProduct->slug)); ?>" class="prev-btn flex items-center cursor-pointer text-secondary hover:text-black pr-3 border-r border-line">
                                    <i class="ph ph-caret-circle-left text-2xl text-black"></i>
                                    <span class="caption1 pl-1">Previous Product</span>
                                </a>
                <?php endif; ?>
                            <?php if($nextProduct): ?>
                                <a href="<?php echo e(route('product.show', $nextProduct->slug)); ?>" class="next-btn flex items-center cursor-pointer text-secondary hover:text-black">
            ...
            <div class="featured-product underwear filter-product-img bg-linear pt-7 md:pb-20 pb-10">
                ...
                ?>
                            ...
                            <div class="swiper mySwiper">
                                <div class="swiper-wrapper">
                                    <?php $__currentLoopData = $allImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="swiper-slide">
                                            <img src="<?php echo e($img); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover cursor-pointer" />
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
            </div>
                    ...
                    <div class="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2" data-default-size="<?php echo e($firstSize ?? $availableSizes[0] ?? ''); ?>">
                        <div class="sticky">
                            <div class="flex justify-between">
                                <div>
                                    <div class="product-category caption2 text-secondary font-semibold uppercase"><?php echo e($product->category->name ?? 'Product'); ?></div>
                                    <div class="product-name heading4 mt-1"><?php echo e($product->name); ?></div>
                                </div>
                                <div class="add-wishlist-btn w-10 h-10 flex-shrink-0 flex items-center justify-center border border-line cursor-pointer rounded-lg duration-300 hover:bg-black hover:text-white" data-product-id="<?php echo e($product->id); ?>">
                                    <i class="ph ph-heart text-xl"></i>
                                </div>
                            </div>
                            <div class="flex items-center gap-1 mt-3">
                                <?php $avg = $reviewStats['avg'] ?? 0; $rc = $reviewStats['count'] ?? 0; ?>
                                <div class="rate flex">
                                    <?php for($s = 1; $s <= 5; $s++): ?>
                                        <i class="ph <?php echo e($s <= round($avg) ? 'ph-fill' : 'ph'); ?> ph-star text-sm <?php echo e($s <= round($avg) ? 'text-yellow' : 'text-line'); ?>"></i>
                                    <?php endfor; ?>
                                </div>
                                <span class="caption1 text-secondary">(<?php echo e(number_format($rc)); ?> <?php echo e($rc === 1 ? 'review' : 'reviews'); ?>)</span>
                            </div>
                            <div class="flex items-center gap-3 flex-wrap mt-5 pb-6 border-b border-line">
                                <div class="product-description text-secondary mt-3 w-full"><?php echo e($product->short_description ?? ($product->description ? \Illuminate\Support\Str::limit($product->description, 150) : 'No description available.')); ?></div>
                            </div>
                                ...
                                <div class="discount-code">
                                    <?php if($coupons && $coupons->count() > 0): ?>
                                        ...
                                        <div class="flex items-center gap-3 mt-3">
                                            <?php $__currentLoopData = $coupons->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="content absolute top-1/2 -translate-y-1/2 md:right-1 right-2 flex items-center gap-2">
                                                        <div class="caption1 text-white">
                                                            <?php if(isset($coupon->discount_type) && $coupon->discount_type === 'percentage'): ?>
                                                                <?php echo e($coupon->discount_value ?? 0); ?>% Off
                                                            <?php else: ?>
                                                                ₹<?php echo e(number_format($coupon->discount_value ?? 0, 2)); ?> Off
                                                            <?php endif; ?>
                                                        </div>
                                                        <div class="button bg-white font-semibold text-xs py-1 px-2 rounded-full duration-300 hover:bg-black hover:text-white cursor-pointer apply-coupon-btn" data-coupon-code="<?php echo e($coupon->code); ?>">Apply</div>
                                                    </div>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php endif; ?>
                                ...
                                <?php if(count($availableColors) > 0): ?>
                                    <div class="choose-color mt-5" data-color-images="<?php echo e(json_encode($colorImageUrls)); ?>">
                                        <div class="text-title">Colors: <span class="text-title color selected-color"><?php echo e($availableColors[0] ?? ''); ?></span></div>
                                        <div class="list-color flex items-center gap-2 flex-wrap mt-3">
                                            <?php $__currentLoopData = $availableColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="color-item w-10 h-10 rounded-full border-2 border-transparent hover:border-black cursor-pointer duration-300 <?php echo e($loop->first ? 'active border-black' : ''); ?>" 
                ...
                <?php endif; ?>
                                ...
                                <div class="choose-quantity flex items-center max-xl:flex-wrap lg:justify-between gap-5 mt-3">
                                    ...
                                    <div class="add-cart-btn button-main whitespace-nowrap w-full text-center bg-white text-black border border-black cursor-pointer" data-product-id="<?php echo e($product->id); ?>">Add To Cart</div>
                                </div>
                                <!-- Pincode Checker -->
                                ...
                                <div class="button-block mt-5 flex gap-3">
                                    <a href="<?php echo e(route('customize')); ?>" class="button-main flex-1 text-center border-0 cursor-pointer bg-black text-white font-semibold py-3 px-4 uppercase no-underline">Customize</a>
                                    <button type="button" class="buy-it-now-btn button-main flex-1 text-center border-0 cursor-pointer bg-black text-white font-semibold py-3 px-4 uppercase" data-product-id="<?php echo e($product->id); ?>" data-checkout-url="<?php echo e(route('checkout.index')); ?>">Buy It Now</button>
                                </div>
                            </div>
                    ...
                    <div class="desc-block mt-8">
                        <div class="desc-item description open" data-item="Description">
                            <div class="grid md:grid-cols-2 gap-8 gap-y-5">
                                <div class="left">
                                    ...
                                    <div class="desc-detail-wrapper">
                                        <div class="text-secondary mt-2 desc-detail-content <?php echo e(!$isHtml && strlen(strip_tags($detailedText)) > 300 ? 'desc-truncated' : ''); ?> <?php if($isHtml): ?> product-description-html <?php endif; ?>">
                                            <?php if($product->description): ?>
                                                ...
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <span class="text-secondary2"><?php echo e($product->short_description ?: 'No detailed description has been added for this product.'); ?></span>
                                            <?php endif; ?>
                                        </div>
                                        <?php if(!$isHtml && strlen(strip_tags($detailedText)) > 300): ?>
                                    ...
                                    <div class="list-feature">
                                        <?php if($product->short_description): ?>
                                            <div class="item flex gap-1 text-secondary mt-1 about-short-wrap">
                                                ...
                                                <div>
                                                    <p class="about-short-content <?php echo e(strlen($product->short_description) > 120 ? 'about-truncated' : ''); ?>"><?php echo e($product->short_description); ?></p>
                                                    <?php if(strlen($product->short_description) > 120): ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if(isset($availableSizes) && count($availableSizes) > 0): ?>
                                            <div class="item flex gap-1 text-secondary mt-1">
                                                <i class="ph ph-dot text-2xl"></i>
                                                <p>Size: <?php echo e(implode(', ', $availableSizes)); ?></p>
                                            </div>
                                        <?php endif; ?>
                                        <?php if(isset($availableColors) && count($availableColors) > 0): ?>
                                            <div class="item flex gap-1 text-secondary mt-1">
                                                <i class="ph ph-dot text-2xl"></i>
                                                <p>Colors: <?php echo e(implode(', ', $availableColors)); ?></p>
                                            </div>
                                        <?php endif; ?>
                            ...
                            <div class="grid lg:grid-cols-4 grid-cols-2 gap-[30px] md:mt-10 mt-6">
                                ...
                                <div class="item">
                                    <div class="icon-delivery-truck text-4xl"></div>
                                    <div class="heading6 mt-4"><?php echo e($f1Title); ?></div>
                                    <div class="text-secondary mt-2"><?php echo e($f1Text); ?></div>
                                </div>
                                <div class="item">
                                    <div class="icon-cotton text-4xl"></div>
                                    <div class="heading6 mt-4"><?php echo e($f2Title); ?></div>
                                    <div class="text-secondary mt-2"><?php echo e($f2Text); ?></div>
                                </div>
                                <div class="item">
                                    <div class="icon-guarantee text-4xl"></div>
                                    <div class="heading6 mt-4"><?php echo e($f3Title); ?></div>
                                    <div class="text-secondary mt-2"><?php echo e($f3Text); ?></div>
                                </div>
                                <div class="item">
                                    <div class="icon-leaves-compatible text-4xl"></div>
                                    <div class="heading6 mt-4"><?php echo e($f4Title); ?></div>
                                    <div class="text-secondary mt-2"><?php echo e($f4Text); ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="desc-item specifications flex items-center justify-center" data-item="Specifications">
                            <div class="lg:w-1/2 sm:w-3/4 w-full">
                                ...
                                <div class="item flex items-center gap-8 py-3 px-10">
                                    ...
                                    <p><?php echo e(implode(', ', $availableSizes)); ?></p>
                                </div>
                                <?php endif; ?>
                                <?php if(isset($availableColors) && count($availableColors) > 0): ?>
                                <div class="item bg-surface flex items-center gap-8 py-3 px-10">
                                    <div class="text-title sm:w-1/4 w-1/3">Colors</div>
                                    <p><?php echo e(implode(', ', $availableColors)); ?></p>
                                </div>
                                <?php endif; ?>
                                <?php if($product->specifications && is_array($product->specifications) && count($product->specifications) > 0): ?>
                                    <?php $specIndex = 0; ?>
                                    <?php $__currentLoopData = $product->specifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="item <?php echo e($specIndex % 2 == 0 ? '' : 'bg-surface'); ?> flex items-center gap-8 py-3 px-10">
                                        <div class="text-title sm:w-1/4 w-1/3"><?php echo e($key); ?></div>
                                        <p><?php echo e($value); ?></p>
                                    </div>
                                    <?php $specIndex++; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                                <?php if((isset($availableSizes) && count($availableSizes) > 0) || (isset($availableColors) && count($availableColors) > 0) || ($product->specifications && is_array($product->specifications) && count($product->specifications) > 0)): ?>
                                <?php else: ?>
                                <div class="item flex items-center gap-8 py-3 px-10">
                        ...
                        <div class="desc-item review" data-item="Review">
                            <?php echo $__env->make('partials.product-reviews', ['product' => $product, 'reviews' => $reviews, 'reviewStats' => $reviewStats], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container py-10">
                ...
                <div class="w-full max-w-[720px] mx-auto rounded-2xl overflow-hidden bg-black shadow-lg" style="position: relative; padding-bottom: 56.25%; height: 0;">
                    <video 
                        ...
                        preload="metadata"
                    >
                        <source src="<?php echo e(storage_asset($product->video)); ?>#t=0.1" type="video/mp4">
                        <source src="<?php echo e(storage_asset($product->video)); ?>" type="video/mp4">
                        <source src="<?php echo e(storage_asset($product->video)); ?>" type="video/quicktime">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/product/show.blade.php ENDPATH**/ ?>