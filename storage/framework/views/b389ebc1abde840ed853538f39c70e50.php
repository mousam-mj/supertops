...
<?php $__env->startSection('page-title', 'Reports & Downloads'); ?>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('admin.dashboard.reports.skus')); ?>" class="btn btn-primary btn-sm w-100">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body">
                ...
                <form method="GET" action="<?php echo e(route('admin.dashboard.reports.orders')); ?>" class="report-form">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body">
                ...
                <form method="GET" action="<?php echo e(route('admin.dashboard.reports.revenue')); ?>" class="report-form">
                    <div class="row g-2 mb-2">
                        <div class="col-6">
                            <input type="date" name="start_date" class="form-control form-control-sm" placeholder="Start">
                        </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body">
                ...
                <form method="GET" action="<?php echo e(route('admin.dashboard.reports.customers')); ?>" class="report-form">
                    <div class="row g-2 mb-2">
                        <div class="col-6">
                            <input type="date" name="start_date" class="form-control form-control-sm" placeholder="Start">
                        </div>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/admin/reports/index.blade.php ENDPATH**/ ?>