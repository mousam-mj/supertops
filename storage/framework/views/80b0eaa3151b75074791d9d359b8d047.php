<?php $__env->startSection('title', 'Checkout - Perch Bottle'); ?>
                    ...
                    <div class="left lg:w-1/2">
                        <div class="login bg-surface py-3 px-4 flex justify-between rounded-lg">
                            <?php if(auth()->guard()->check()): ?>
                                <div class="left flex items-center"><span class="text-on-surface-variant1">You're already logged in with <?php echo e(auth()->user()->email); ?></span></div>
                            <?php else: ?>
                                <div class="left flex items-center"><span class="text-on-surface-variant1 pr-4">Already have an account? </span><a href="<?php echo e(route('login')); ?>?redirect=<?php echo e(urlencode(route('checkout.index'))); ?>" class="text-button text-on-surface hover:underline cursor-pointer">Login</a></div>
                                <a href="<?php echo e(route('login')); ?>?redirect=<?php echo e(urlencode(route('checkout.index'))); ?>" class="right flex items-center"><i class="ph ph-caret-right fs-20 cursor-pointer"></i></a>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="information mt-5">
                            ...
                            <?php if(auth()->check() && $addresses && $addresses->count() > 0): ?>
                                <div class="mt-4 mb-4">
                                    ...
                                    <div class="select-block">
                                        <select class="border border-line px-4 py-3 w-full rounded-lg" id="savedAddressSelect" onchange="fillAddressFromSaved(this.value)">
                                            ...
                                            <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($address->id); ?>" data-address='<?php echo json_encode($address, 15, 512) ?>' <?php echo e($address->is_default ? 'selected' : ''); ?>>
                                                    <?php echo e($address->label ?? 'Address'); ?> - <?php echo e($address->address_line_1); ?>, <?php echo e($address->city); ?>
                                    ...
                                    <input type="hidden" id="selectedAddressId" name="shipping_address_id" value="<?php echo e($defaultAddress->id ?? ''); ?>">
                                </div>
                            <?php endif; ?>
                            <div class="form-checkout mt-5">
                                <form onsubmit="return false;" id="checkout-form-element">
                                    <div class="grid sm:grid-cols-2 gap-4 gap-y-5 flex-wrap">
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" id="firstName" type="text" placeholder="First Name *" value="<?php echo e($userFirstName ?? ($defaultAddress ? explode(' ', $defaultAddress->full_name)[0] : '')); ?>" required />
                                        </div>
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" id="lastName" type="text" placeholder="Last Name *" value="<?php echo e($userLastName ?? ($defaultAddress ? (explode(' ', $defaultAddress->full_name)[1] ?? '') : '')); ?>" required />
                                        </div>
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" id="email" type="email" placeholder="Email Address *" value="<?php echo e($user->email ?? ''); ?>" required />
                                        </div>
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" id="phoneNumber" type="tel" placeholder="Phone Number *" value="<?php echo e($user->phone ?? ($defaultAddress->phone ?? '')); ?>" required />
                                        </div>
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" id="region" name="region" type="text" placeholder="Country *" value="<?php echo e($defaultAddress->country ?? 'India'); ?>" required />
                                        </div>
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" id="city" type="text" placeholder="Town/City *" value="<?php echo e($defaultAddress->city ?? ''); ?>" required />
                                        </div>
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" id="apartment" type="text" placeholder="Street *" value="<?php echo e($defaultAddress->address_line_1 ?? ''); ?>" required />
                                        </div>
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" id="country" name="country" type="text" placeholder="State *" value="<?php echo e($defaultAddress->state ?? ''); ?>" required />
                                        </div>
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" id="postal" type="text" placeholder="Postal Code *" value="<?php echo e($defaultAddress->pincode ?? ''); ?>" required />
                                        </div>
    ...
    window.handleRazorpayPayment = function(orderData) {
        ...
        .then(data => {
            ...
            if (data.success && data.data) {
                ...
                const options = {
                    key: data.data.key || '<?php echo e(config("services.razorpay.key")); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mousamjain/Documents/GitHub/edx/resources/views/checkout/index.blade.php ENDPATH**/ ?>