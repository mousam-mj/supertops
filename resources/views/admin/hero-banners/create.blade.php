                ...
                <form action="{{ route('admin.hero-banners.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="e.g. THE COMFORT YOU CARRY">
                            @error('name')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('subtitle') is-invalid @enderror" id="subtitle" name="subtitle" value="{{ old('subtitle') }}" placeholder="e.g. the Calm You Remember">
                            @error('subtitle')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('deeplink') is-invalid @enderror" id="deeplink" name="deeplink" value="{{ old('deeplink') }}" placeholder="/shop or https://...">
                            @error('deeplink')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
