                                                ...
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="{{ route('search') }}" class="link text-secondary duration-300 active"> Search Result </a>
                                                            </li>
                                                            <li>
        ...
        <div class="shop-product search-result-block lg:py-20 md:py-14 py-10">
            <div class="container">
                <div class="heading flex flex-col items-center">
                    <div class="heading4 text-center">Found <span class="result-quantity">0</span> results for "<span class="result"></span>"</div>
                    <div class="input-block lg:w-1/2 sm:w-3/5 w-full md:h-[52px] h-[44px] sm:mt-8 mt-5">
                        <div class="form-search w-full h-full relative">
                            <input type="text" placeholder="Search..." class="caption1 w-full h-full pl-4 md:pr-[150px] pr-32 rounded-xl border border-line" />
                            <button class="button-main absolute top-1 bottom-1 right-1 flex items-center justify-center">search</button>
                        </div>
                    </div>
                </div>

                <div class="list-product-block relative md:pt-10 pt-6">
                    <div class="heading6">product Search: <span class="result"></span></div>
                    <div class="list-product list-product-result hide-product-sold grid lg:grid-cols-4 sm:grid-cols-3 grid-cols-2 sm:gap-[30px] gap-[20px] mt-5"></div>
                </div>
            </div>
        </div>
@endsection
