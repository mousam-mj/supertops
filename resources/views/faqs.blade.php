...
@section('title', 'Faqs - Perch Bottle')
                                        ...
                                        <div class="sub-nav-mobile">
                                            ...
                                            <div class="list-nav-item w-full pt-2 pb-6">
                                                <ul class="w-full">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('faqs') }}" class="link text-secondary duration-300 active"> FAQs </a>
                                                    </li>
                                                    <li>
                    ...
                    @forelse($allItems as $item)
                        <div class="question-item px-7 py-5 rounded-[20px] overflow-hidden border border-line cursor-pointer">
                            <div class="heading flex items-center justify-between gap-6">
                                <div class="heading6">{{ $item->question }}</div>
                                <i class="ph ph-caret-right text-2xl"></i>
                            </div>
                            <div class="content body1 text-secondary">{!! nl2br(e($item->answer)) !!}</div>
                        </div>
                    @empty
