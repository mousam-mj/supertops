...
@section('title', 'Product Two Scrolling - Perch Bottle')
                                                ...
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    ...
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="{{ route('product.show', $product->slug ?? '#') }}" class="link text-secondary duration-300 cursor-pointer active"> Products Grid 2 Scrolling </a>
                                                            </li>
                                                            <li>
