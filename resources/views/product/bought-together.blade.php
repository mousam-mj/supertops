...
@section('title', 'Product Bought Together - Perch Bottle')
                                                ...
                                                <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                    <div class="nav-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="{ route('product.show', $product->slug ?? '#') }" class="link text-secondary duration-300 active"> Frequently Bought Together </a>
                                                            </li>
                                                            <li>
