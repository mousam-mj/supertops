...
@section('title', 'Blog Detail1 - Perch Bottle')
                                        ...
                                        <div class="sub-nav-mobile">
                                            ...
                                            <div class="list-nav-item w-full pt-2 pb-6">
                                                <ul class="w-full">
                                                    ...
                                                    <li>
                                                        <a href="{ route('blog.show', $post->slug ?? '#') }" class="link text-secondary duration-300 active"> Blog Detail 1 </a>
                                                    </li>
                                                    <li>
                        ...
                        <div class="action flex items-center justify-between flex-wrap gap-5 md:mt-8 mt-5">
                            <div class="left flex items-center gap-3 flex-wrap">
                                ...
                                <div class="list flex items-center gap-3 flex-wrap">
                                    <a href="{ route('blog') }" class="tags bg-surface py-1.5 px-4 rounded-full text-button-uppercase cursor-pointer duration-300 hover:bg-black hover:text-white"> fashion </a>
                                    <a href="{ route('blog') }" class="tags bg-surface py-1.5 px-4 rounded-full text-button-uppercase cursor-pointer duration-300 hover:bg-black hover:text-white"> yoga </a>
                                    <a href="{ route('blog') }" class="tags bg-surface py-1.5 px-4 rounded-full text-button-uppercase cursor-pointer duration-300 hover:bg-black hover:text-white"> organic </a>
                                </div>
                            </div>
