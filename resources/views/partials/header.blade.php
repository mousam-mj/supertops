                                ...
                                <ul class="flex items-center gap-8 h-full">
                                    <li class="h-full relative">
                                        ...
                                        <div class="sub-menu py-3 px-5 -left-10 w-max absolute grid grid-cols-4 gap-5 bg-white rounded-b-xl">
                                            <ul>
                                                <li>
                                                    <a href="{{ route('home') }}" class="link text-secondary duration-300 active"> Home Fashion 1 </a>
                                                </li>
                                                <li>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="cosmetic3.html" class="link text-secondary duration-300"> Home Cosmetic 3 </a>
                                                </li>
                                                <li>
                                                ...
                                                <div class="flex justify-between py-8">
                                                    <div class="nav-link basis-2/3 grid grid-cols-4 gap-y-8">
                                                        ...
                                                        <div class="nav-item">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Shirt | Clothes </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Top | Overshirts </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> T-shirts | Clothes </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Swimwear | Underwear </a>
                                                                </li>
                                                                <li>
                                                        ...
                                                        <div class="nav-item">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Hair Care </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 view-all-btn"> View All </a>
                                                                </li>
                                                        ...
                                                        <div class="nav-item">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Cented Candle </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Health Drinks </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Yoga Clothes </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Yoga Equipment </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 view-all-btn"> View All </a>
                                                                </li>
                                                        ...
                                                        <div class="nav-item">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Starting From 60% Off </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Dresses | Jumpsuits </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> T-shirts | Sweatshirts </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Accessories | Jewelry </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 view-all-btn"> View All </a>
                                                                </li>
                                                        ...
                                                        <div class="nav-item">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Kids Bed </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Boy's Toy </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Baby Blanket </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Newborn Clothing </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 view-all-btn"> View All </a>
                                                                </li>
                                                        ...
                                                        <div class="nav-item">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Furniture | Decor </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Table | Living Room </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Chair | Work Room </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Lighting | Bed Room </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 view-all-btn"> View All </a>
                                                                </li>
                                                    ...
                                                    <div class="banner-ads-block pl-2.5 basis-1/3">
                                                        ...
                                                        <a href="shop-breadcrumb1.html" class="banner-ads-item bg-linear rounded-2xl relative block overflow-hidden cursor-pointer mt-8">
                                                            <div class="text-content py-14 pl-8 relative z-[1]">
                                                                <div class="text-button-uppercase text-white bg-red px-2 py-0.5 inline-block rounded-sm">Save $10</div>
                                    ...
                                    <li>
                                        ...
                                        <div class="sub-nav-mobile">
                                            ...
                                            <div class="list-nav-item w-full grid grid-cols-2 pt-2 pb-6">
                                                <ul>
                                                    <li>
                                                        <a href="{{ route('home') }}" class="nav-item-mobile link text-secondary duration-300 active"> Home Fashion 1 </a>
                                                    </li>
                                                    <li>
