    ...
    public static function all(): array
    {
        ...
        return [
            ...
            'terms-and-conditions' => [
                ...
                'content' => <<<'HTML'
<p>Welcome to Perch Bottle. By accessing and using this website, you accept and agree to be bound by the following terms and conditions.</p>
...
HTML,
            ...
            'privacy-policy' => [
                ...
                'content' => <<<HTML
<p>At Perch Bottle, we are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and safeguard your data when you visit our website or make a purchase.</p>
<h5>Who we are</h5>
<p>We are the manufacturers of stainless steel bottles and lunchboxes under the brand name Perch. Our official website is: {$homeUrl}.</p>
...
HTML,
            ...
            'return-and-refund' => [
                ...
                'content' => <<<'HTML'
<p>At Perch Bottle, we want you to be completely satisfied with your purchase. Please read our return and refund policy carefully.</p>
...
HTML,
            ...
            'cancellation-policy' => [
                ...
                'content' => <<<'HTML'
<p>At Perch Bottle, we understand that sometimes plans change. Here is our cancellation policy for orders.</p>
