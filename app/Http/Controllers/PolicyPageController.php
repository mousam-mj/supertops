...
class PolicyPageController extends Controller
{
    ...
    /**
     * Display a policy page by slug. Uses DB if available, else default content.
     */
    public function show(string $slug)
    {
        ...
        $page = null;
        try {
            $page = PolicyPage::getBySlug($slug);
        } catch (\Throwable $e) {
            // Table may not exist yet
        }

        if (! $page) {
            $page = self::getDefaultPage($slug);
        } else {
            // Use DB content; ensure we have something to show
            if (trim((string) $page->content) === '') {
                $default = self::getDefaultPage($slug);
    ...
    /**
     * Return default title and content for a slug (object with title, content).
     */
    protected static function getDefaultPage(string $slug): object
    {
        $homeUrl = url('/');
        $defaults = [
            'about-us' => [
...
<h5 class="heading5 text-black font-semibold mt-8">Our story</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">Our mission</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">Why choose us</h5>
<p>We use food-grade stainless steel, ensure leak-proof designs, and offer responsive customer support. <a href="' . route('contact') . '" class="text-button hover:underline">Get in touch</a> for any queries or feedback.</p>
...
<h5 class="heading5 text-black font-semibold mt-8">1. Use of Website</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">2. Intellectual Property</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">3. Product Information</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">4. Limitation of Liability</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">5. Changes</h5>
...
<p>If you have any questions about these Terms &amp; Conditions, please <a href="' . route('contact') . '" class="text-button hover:underline">contact us</a>.</p>',
            ],
            'privacy-policy' => [
...
<p>We are the manufacturers of stainless steel bottles and lunchboxes under the brand name Perch. Our official website is: <a href="' . $homeUrl . '" class="text-button hover:underline">' . e($homeUrl) . '</a>.</p>
<h5 class="heading5 text-black font-semibold mt-8">Information we collect</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">How we use your information</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">Data security</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">Cookies</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">Your rights</h5>
<p>You may request access to, correction of, or deletion of your personal data. <a href="' . route('contact') . '" class="text-button hover:underline">Contact us</a> for any privacy-related requests.</p>
...
<h5 class="heading5 text-black font-semibold mt-8">Return eligibility</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">Non-returnable items</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">How to initiate a return</h5>
<p>Contact our customer support at the email or phone number provided on our <a href="' . route('contact') . '" class="text-button hover:underline">Contact</a> page. Include your order number and reason for return. We will provide you with return instructions and a Return Authorization if applicable.</p>
<h5 class="heading5 text-black font-semibold mt-8">Refund process</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">Shipping costs</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">Damaged or defective items</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">Cancellation by customer</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">How to cancel</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">Cancellation by Perch Bottle</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">Refund after cancellation</h5>
...
<h5 class="heading5 text-black font-semibold mt-8">Prepaid orders</h5>
...
<p>If you have any questions about cancelling your order, please <a href="' . route('contact') . '" class="text-button hover:underline">contact our customer support team</a>.</p>',
            ],
        ];

        $data = $defaults[$slug] ?? ['title' => 'Policy', 'content' => '<p>Content not available.</p>'];
        return (object) [
            'title' => $data['title'],
